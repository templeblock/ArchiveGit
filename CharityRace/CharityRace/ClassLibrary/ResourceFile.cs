...
namespace ClassLibrary
{
	...
	//
	//		BitmapImage bitmap1 = ResourceFile.GetBitmap("Images/Clouds.jpg", Assembly.App);
	//
	// Get content from a ZIP:
	//
	//		BitmapImage bitmap2 = ResourceFile.GetBitmapFromZip("Content/Zips/Files.zip", "Clouds.jpg", Assembly.App);
	//
	// Get content streams:
	//
	//		Stream bitmapStream = ResourceFile.GetStream("Images/Clouds.jpg", Assembly.App);
	//		Stream zipStream = ResourceFile.GetStream("Content/Zips/Files.zip", Assembly.App);

	internal static class ResourceFile
	{
		// Get a bitmap from an assembly or the XAP
		internal static BitmapImage GetBitmap(string relativeUri, Assembly assembly)
		{
		...
		internal static BitmapImage GetBitmapFromZip(string relativeZipUri, string relativeUri, Assembly assembly)
		{
		...
		internal static string GetFileText(string relativeUri, Assembly assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		internal static string GetFileTextFromZip(string relativeZipUri, string relativeUri, Assembly assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetFileTextFromStream(stream);
		}
		...
		internal static FontSource GetFont(string relativeUri, Assembly assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		internal static FontSource GetFontFromZip(string relativeZipUri, string relativeUri, Assembly assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetFontFromStream(stream);
		}
		...
		internal static UIElement GetXaml(string relativeUri, Assembly assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		internal static UIElement GetXamlFromZip(string relativeZipUri, string relativeUri, Assembly assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetXamlFromStream(stream);
		}
		...
		internal static XmlReader GetXmlReader(string relativeUri, Assembly assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		internal static XmlReader GetXmlReaderFromZip(string relativeZipUri, string relativeUri, Assembly assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetXmlReaderFromStream(stream);
		}
...
//j				MessageBox.Show(ex.Message, "Alert", MessageBoxButton.OK);
		...
		internal static Stream GetStream(string relativeUri, Assembly assembly)
		{
		...
		internal static Stream GetStreamFromZip(string relativeZipUri, string relativeUri, Assembly assembly)
		{
