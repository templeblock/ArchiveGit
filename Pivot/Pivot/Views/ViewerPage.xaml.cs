...
namespace Pivot
{
	public partial class ViewerPage : Page
	{
		...
		public ViewerPage()
		{
			...
			x_PivotViewer.PropertyChanged += OnPivotViewerPropertyChanged;
		...
		void OnPivotViewerPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
		}
		...
		{
			x_PivotViewer.ZoomSlider.PropertyChanged += OnZoomSliderPropertyChanged;
		}

		public void OnZoomSliderPropertyChanged(object sender, PropertyChangedEventArgs args)
		{
			// check ZoomSlider.Value 
		}
		...
		private void LoadCollection(string collectionName)
		{
			...
			//j	PivotViewerHistory.Create(x_PivotViewer, new Uri(baseCollectionUri));
		}
		...
		{
			x_PivotViewer.ZoomOut();
		}

		private void OnZoomInClick(object sender, RoutedEventArgs e)
		{
			x_PivotViewer.ZoomIn();
		}
		...
		private void OnToggleBackgroundClick(object sender, RoutedEventArgs e)
		{
			...
			x_PivotViewer.CollectionBackgroundBrush = background;
		}
