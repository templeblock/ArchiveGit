...
namespace Pivot.Web
{
	public partial class DefaultPage : Page
	{
		...
		public string GetCollectionUrlsScript()
		{
			// Name, Summary, and SampleQueries
			string script = null;
			foreach (string item in JITHttpRequestLibrary.PivotHttpHandlers.GetCollectionUrls())
			{
				script += (script == null ? "return [ " : ", ");
				script += "\"" + /*HttpUtility.HtmlEncode*/(item) + "\"";
			}
			script += " ];";
			return script;
		}
