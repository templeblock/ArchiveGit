...
namespace Pivot.Web
{
	...
	public class CollectionTileHandler : IHttpHandler
	{
		public bool IsReusable { get { return true; } }

		public void ProcessRequest(HttpContext context)
		{
			PivotHttpHandlers.ServeCollectionTile(context);
		}
	}
	...
	public class DziTileHandler : IHttpHandler
	{
		public bool IsReusable { get { return true; } }

		public void ProcessRequest(HttpContext context)
		{
			PivotHttpHandlers.ServeDziTile(context);
		}
	}
}
