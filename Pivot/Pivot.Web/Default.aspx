...
<head runat="server">
	...
	<meta name="description" content="The easiest way to visualize historical baseball data and card images."></meta>
	...
	<script type="text/javascript">
		...
		{
			<% Response.Write(GetCollectionUrlsScript()); %>
		}
	</script>
</head>
<body>
		...
		<div id="silverlightControlHost">
			...
			<param name="source" value="ClientBin/Pivot.xap"/>
				...
				<div id="silverlightNotInstalled">
					<h3>McPivot.&nbsp; The easiest way to visualize baseball data and card images.</h3>
