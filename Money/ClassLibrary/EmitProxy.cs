...
{
	// Article: http://www.codeproject.com/KB/cs/Emit_Proxy.aspx
	...
	public static class EmitProxy
	{
		...
		private static IEnumerable<CustomAttributeBuilder> CreateCustomAttributeBuilder(MemberInfo oldMember)
		{
			return null;
#if false
			foreach (CustomAttributeData att in System.Reflection.CustomAttributeData.GetCustomAttributes(oldMember))
			{
