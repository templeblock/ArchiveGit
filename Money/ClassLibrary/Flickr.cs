...
namespace ClassLibrary
{
	...
	internal class GetStreamAsyncEventArgs : AsyncCompletedEventArgs
	{
		// Fields
	...
	internal abstract class Photo
	{
		...
		protected void OnOriginalStreamReady(GetStreamAsyncEventArgs e)
		{
			if (this.CreateOriginalStreamCompleted != null)
			{
				this.CreateOriginalStreamCompleted(this, e);
			}
		}

		protected void OnThumbnailStreamReady(GetStreamAsyncEventArgs e)
		{
			if (this.CreateThumbnailStreamCompleted != null)
			{
				this.CreateThumbnailStreamCompleted(this, e);
			}
		}
	...
	internal class DownloadManager : FrameworkTemplate
	{
	}

	internal class FlickrApiFormats
	{
		// Fields
	...
	internal class PhotoFlickr : Photo
	{
		// Methods
	...
	internal class FlickrAuthenticationCycle : FrameworkTemplate
	{
		// Fields
		...
		// Events
		public event EventHandler FlickrAccessErrored;

		public event EventHandler PhotoSetsLoaded;
