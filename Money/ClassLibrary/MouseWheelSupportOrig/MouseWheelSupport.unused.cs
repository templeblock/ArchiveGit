...
namespace ClassLibrary
{
	internal class MouseWheelSupport
	{
		...
		private static readonly ElementTree m_elementStateTree = new ElementTree();

		private readonly ElementNode m_elementState;
		...
		{
			rootVisual.MouseMove += RootVisualMouseMove;
		}
		...
		{
			private static readonly IList<ElementNode> m_nodes = new List<ElementNode>();
		...
		private class ElementNode
		{
			...
			private readonly IList<ElementNode> m_children = new List<ElementNode>();
	...
	{
		private readonly double m_wheelDelta;
		private bool m_browserEventHandled;
