...
#define HPAPP 1
#define NORMAL_MESSAGEBOX (XMLUTIL || CTPUTIL || 1)
...
#define ERROR_NO_OBJECT_SELECTED	"Open an image before using this function."
...
bool CMessageBox::ComputeMessageBoxRect(RECT& rMessageBox, LPCTSTR pMessage)
{
	...
	#define MSGBOX_FONTFACE		"Microsoft Sans Serif"
	...
	Font.lfWidth = 0;
	strcpy_s(Font.lfFaceName, sizeof(Font.lfFaceName), MSGBOX_FONTFACE);
