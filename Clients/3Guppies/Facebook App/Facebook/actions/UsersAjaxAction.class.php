...
/**
 * UsersAjax action for the Facebook application
 *
 *
 * @author  Jim McCurdy
 */
class UsersAjaxAction extends Action
{
	/**
	...
	function execute (&$controller, &$request, &$user)
	{
		...
		$arrUsers = GetViewUsersForMobilize(GetFriendsArray(), $bAddPhotoCount, $userid);
...
//j		$request->setParameter('no_header_footer', 1);
		...
		// returning index view because this is the only view for the UsersAjax page
		return VIEW_INDEX;
	}
