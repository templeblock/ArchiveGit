...
/**
 * Terms action for the Facebook application
 *
 *
 * @author  Jim McCurdy
 */
class TermsAction extends Action
{
	...
	function execute (&$controller, &$request, &$user)
	{
		...
		//$facebook->require_add(); // Can't require add becuase this page can be accessed from the add process
		...
		// returning index view because this is the only view for the Terms page
		return VIEW_INDEX;
	}
