...
if ( iModeless )
	{
	hDlg = CreateDialog( hInstance, MAKEINTRESOURCE(idDlgIn), hWndParent,
	  lpProc );

	if (! hDlg)
		return((int)hDlg);

	AstralDlgSet( idDlgIn, hDlg, lpProc );
	SetWindowPos( hDlg,
...
/* let windows take care of the whole matter right now */
	...
	iResult = DialogBox( hInstance, MAKEINTRESOURCE(idDlgIn), hWndParent,
	  lpProc );
...
/***********************************************************************/
int CALLBACK EXPORT AstralDlgEnd(
/***********************************************************************/
HWND	hDlg,
int		iResult)
{
...
/***********************************************************************/
BOOL AstralDlgSet( ITEMID idDlg, HWND hDlg, DLGPROC lpProc )
/***********************************************************************/
{
int	i;
