...
#else				
					GrayScaleToLineArt(lpIn, lpOut, iCount);
#endif
				break;
...
#else
					RGBColorToLineArt(lpIn, lpOut, iCount );
#endif
				break;
...
#else
					CMYKColorToLineArt(lpIn, lpOut, iCount);
#endif
				break;
		    }
		break;
...
#else
					LineArtToGrayScale(lpIn, lpOut, iCount);
#endif
				break;
...
#else
					RGBColorToGrayScale( lpIn, lpOut, iCount );
#endif
				break;
...
#else	
					CMYKColorToGrayScale( lpIn, lpOut, iCount );
#endif
				break;
		    }
		break;
...
#else
					LineArtToRGBColor(lpIn, lpOut, iCount);
#endif
				break;
...
#else
					GrayScaleToRGBColor(lpIn, lpOut, iCount );
#endif
				break;
...
#else
					CMYKColorToRGBColor( lpIn, lpOut, iCount );
#endif
				break;
	    	}
		break;
...
#else
					LineArtToCMYKColor(lpIn, lpOut, iCount);
#endif
				break;
...
#else	
					GrayScaleToCMYKColor(lpIn, lpOut, iCount);
#endif
				break;
...
#else
					RGBColorToCMYKColor( lpIn, lpOut, iCount );
#endif
				break;
