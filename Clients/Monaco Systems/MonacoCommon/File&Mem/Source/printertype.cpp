...
// set up some resonable defaults first
	...
	data.saturation = 80;		// from 0 to 100, 100 is max saturation
	data.col_balance = 100;	// 0 = neutral, 100 = paper color
	data.L_linear = 80;		// 0 = linear, 100 = compressed
	data.ink_linerize = 0;	// lineraize ink L
	data.ink_neutralize = 1; // neutralize ink sim for paper color
