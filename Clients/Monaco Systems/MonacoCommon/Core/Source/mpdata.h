...
typedef struct SettingFormat {
	...
	char							toneDesc[100];
	unsigned long					flag;
	unsigned long					linearDate;  // time in seconds since midnight 1/1/1970 (Window's date format)
	unsigned long					srcDate;  // for the source data
	unsigned long					dstDate;  // for the destination data
