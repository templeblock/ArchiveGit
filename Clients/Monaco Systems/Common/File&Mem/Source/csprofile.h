...
//	Revision:
//	Date:	4/21/1998
//	1. change minor version to 0x10000000
//	2. change default flags to 0x00000000
//	3. set header.reserved to 0x00
//	4. default platform is set to "MSFT" in case of window
//		
/////////////////////////////////////////////////////////////////////
...
#define MCOP_MAJOR_VERSION	(0x02000000)
#define MCOP_MINOR_VERSION	(0x00000000)
#define MCOP_DEFAULT_CON_SPACE	(cmLabData)
#if defined(_WIN32)
#define MCOP_DEFAULT_PLATFORM	('MSFT')
#else
#define MCOP_DEFAULT_PLATFORM	('APPL')
#endif
#define MCOP_DEFAULT_FLAGS	(0x00000000)	//0x00020000	
...
//	unsigned long 					reserved;					/* fill with 0x00 */
	...
	unsigned long					srcDate;
	unsigned long					dstDate;
	unsigned long					reserved[96];
} MNSettingType;
