...
#define C4TEST
#ifdef C4TEST
extern long lR, lG, lB;
extern short Rper, Gper, Bper;
...
#define CYCLES_TO_MEASURE_DEFAULT   100
...
PDEC long WINAPI FDEC sipOpenCalibrator ( unsigned short usPort, char *szVersion, void *Option );
PDEC long WINAPI FDEC sipCloseCalibrator ( void );
PDEC long WINAPI FDEC sipAutoMeasureYxy ( unsigned short Units, dYxy *YxyData );
PDEC long WINAPI FDEC sipMeasureYxy ( unsigned short Units, dYxy *YxyData );
PDEC long WINAPI FDEC sipMeasMonFreqAndSetIntTime ( unsigned short usNumFields, double *dMonFreq );
PDEC long WINAPI FDEC sipMeasureMonitorFrequency ( double *dMonFreq );
...
PDEC short WINAPI FDEC sipGetCalibratorType ( void );
PDEC long WINAPI FDEC sipGetRGBvaluesFromYxy ( unsigned short usUnits, dYxy dYxySource, dRGB *dRGBResult );
PDEC long WINAPI FDEC sipSetNumPeriodsToMeasure ( unsigned short usNumPeriods );
PDEC long WINAPI FDEC sipGetNumPeriodsToMeasure ( unsigned short *usNumPeriods );
PDEC long WINAPI FDEC sipDarkMeasureYxy ( unsigned short Units, 
		unsigned char ucRedPer, unsigned char ucGreenPer, unsigned char ucBluePer, 
		short	sDarkFlag, dYxy FAR *YxyData );
...
#define ERR_TIMEOUT_NOT_ENABLED		-110 /* timeout has not been enabled */
...
#define ERR_EEPROM_UNINITIALIZED    -506 /* EEPROM has not been initialized */
#define ERR_EEPROM_CORRUPT          -507 /* EEPROM does not contain valid data */
