...
// Extended operations
public:
	void InitCMYK(int nRows);
	void InitLAB(int nRows, char* rgb);
	void InitLABRows(int nRows);
	void InitCMYKRowLabels(int Col, int iFirstRow, int iLastRow, char* rgb);
	void InitLABRowLabels(int iFirstRow, int iLastRow);
	void ProcessClick(void);
	bool ProcessKey(short* pKeyCode, short Shift, CRect* pRect);
	BOOL OutputCMYK( ofstream& out );
	int GetColumn(int iColumn, double* pXArray, double* pYArray, int iArraySize, double dMaxValue);
	void SetColumn(int iColumn, double* pdXArray, double* pdYArray, int iArraySize, double dMaxValue);
// Operations
public:
	void GoHome(void);
	long GetRows();
...
/////////////////////////////////////////////////////////////////////////////
// CGridEvents wrapper class

class CGridEvents : public COleDispatchDriver
{
public:
	CGridEvents() {}		// Calls COleDispatchDriver default constructor
	CGridEvents(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CGridEvents(const CGridEvents& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void LeaveCell();
	void Scroll();
	void Compare(long Row1, long Row2, short* Cmp);
