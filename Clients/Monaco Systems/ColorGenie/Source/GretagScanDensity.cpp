// GretagScan.cpp: implementation of the CGretagScanDensity class.
//
//////////////////////////////////////////////////////////////////////
...
CGretagScanDensity::CGretagScanDensity():CDeviceControl(), m_table()
{

}

CGretagScanDensity::~CGretagScanDensity()
{
	MoveToHome();
}

BOOL	CGretagScanDensity::StartComm(void)
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL CGretagScanDensity::PostPositionDialog(int which)
{
	CPositionDialog positiondialog;

	positiondialog.m_type = 2;
...
BOOL	CGretagScanDensity::AlignTable()
{
	double patchpos[6];
	int		headpos[6];
...
BOOL CGretagScanDensity::GetHeadLocation(int *position, int refrence)
{
	char command[100];
	char data[200];
	int	datalen = 200;
...
BOOL	CGretagScanDensity::Calibrate()
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL CGretagScanDensity::TurnOnLine(void)
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL CGretagScanDensity::TurnOffLine(void)
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL CGretagScanDensity::PutHeadDown()
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL CGretagScanDensity::PutHeadUp()
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL CGretagScanDensity::MoveToHome()
{
	char	data[200];
	int		datalen = 200;
...
BOOL CGretagScanDensity::MoveToPatch(int patchnum, int ref)
{
	char command[200];
	char data[200];
	int	datalen = 200;
...
BOOL	CGretagScanDensity::SendRequest(long whichpatch, CWnd *wnd)
{
	char	data[200];
	int		datalen = 200;
	int		code[5];
...
BOOL	CGretagScanDensity::ProcessResult( CCommRequest *pRequest, double *data)
{
	int	code[5];
	int i;
	double temp;
...
BOOL	CGretagScanDensity::GetPatchPos(int patchnum, double *pos)
{
	m_table.getPatchPoint(patchnum, pos);
	return TRUE;
}

BOOL	CGretagScanDensity::CheckStart(char *data)
{
	if( (data[0] != ';') && (data[0] != ':') )
		return FALSE;
...
BOOL	CGretagScanDensity::CheckError(int *code)
{
...
BOOL	CGretagScanDensity::CheckErrorChart(int *code)
{
