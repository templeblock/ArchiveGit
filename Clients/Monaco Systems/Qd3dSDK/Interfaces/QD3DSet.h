...
typedef TQ3Status (QD3D_CALLBACK *TQ3ElementCopyAddMethod)(	
	const void			*fromAPIElement,			/* element from _Add API call */
	void				*toInternalElement);		/* to new QD3D internal element */

typedef TQ3Status (QD3D_CALLBACK *TQ3ElementCopyReplaceMethod)(
	const void			*fromAPIElement,			/* element from _Add API call */
	void				*ontoInternalElement);		/* replacing QD3D internal element */

typedef TQ3Status (QD3D_CALLBACK *TQ3ElementCopyGetMethod)(
	const void			*fromInternalElement,		/* from QD3D internal element */
	void				*toAPIElement);				/* to _Get API call */

typedef TQ3Status (QD3D_CALLBACK *TQ3ElementCopyDuplicateMethod)(
	const void			*fromInternalElement,		/* from QD3D internal element */
	void				*toInternalElement);		/* to new QD3D internal element */

typedef TQ3Status (QD3D_CALLBACK *TQ3ElementDeleteMethod)(	
	void				*internalElement);

QD3D_EXPORT TQ3ObjectClass QD3D_CALL Q3ElementClass_Register(
 	TQ3ElementType		elementType,
	const char			*name,
	unsigned long		sizeOfElement,
	TQ3MetaHandler		metaHandler);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ElementType_GetElementSize(
 	TQ3ElementType		elementType,
	unsigned long		*sizeOfElement);
...
typedef TQ3Status (QD3D_CALLBACK *TQ3AttributeCopyInheritMethod)(
	const void			*fromInternalAttribute,		/* from QD3D internal element */
	void				*toInternalAttribute);		/* to new QD3D internal element */

QD3D_EXPORT TQ3XObjectClass QD3D_CALL Q3AttributeClass_Register(
	TQ3AttributeType	attributeType,
 ...
 *	Version 1.1
 */
#define kQ3MethodTypeAttributeDefault		Q3_METHOD_TYPE('a','s','d','f')
typedef TQ3Status (QD3D_CALLBACK *TQ3AttributeDefaultMethod)(	
	void				*internalElement);

#define kQ3MethodTypeAttributeIsDefault		Q3_METHOD_TYPE('a','i','d','f')
typedef TQ3Boolean (QD3D_CALLBACK *TQ3AttributeIsDefaultMethod)(	
	void				*internalElement);
