...
/*
 *
 *  A B O U T   Q D 3 D _ O B S O L E T E:
 *
 *
 *  NOTE:the flag QD3D_OBSOLETE is used to mark API calls that are being
 *       deprecated.  This means we intend to remove them in the future.
 *		 If you define the name QD3D_OBSOLETE then the "old" API calls will
 *		 still work.  We recommend switching to the new versions of these
 *		 calls for maximum compatibility.  If you want to enable the flag
 *		 then you should set its value to 1 (true).  For example if you use
 *		 a prefix file then you could place the following line in it:
 *
 *			#define QD3D_OBSOLETE	1
 *
 *		 or if your compiler accepts the -d option, on your compile line add
 *
 *			-d QD3D_OBSOLETE=1
 *
...
#if defined(ESCHER_VER_FUTURE) && ESCHER_VER_FUTURE
	,
	kQ3PixelTypeCL8			= 6,	/* 8-bit color table index			*/
	kQ3PixelTypeCL4			= 7,	/* 4-bit color table index			*/
	kQ3PixelTypeAlpha1		= 8		/* alpha							*/
#endif /* ESCHER_VER_FUTURE */
} TQ3PixelType;
...
typedef void (QD3D_CALLBACK *TQ3FunctionPointer)(
	void);

typedef TQ3FunctionPointer (QD3D_CALLBACK *TQ3MetaHandler)(
 ...
 */
typedef TQ3Status (QD3D_CALLBACK *TQ3ObjectUnregisterMethod)(
 ...
 */
QD3D_EXPORT TQ3Status QD3D_CALL Q3ObjectClass_Unregister(
	TQ3ObjectClass		objectClass);
...
QD3D_EXPORT TQ3ColorTableObject QD3D_CALL Q3ColorTable_New(
	const TQ3ColorTableData		*colorTableData);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_Set(
	TQ3ColorTableObject			colorTable,
	const TQ3ColorTableData		*colorTableData);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_Get(
	TQ3ColorTableObject			colorTable,
	const TQ3ColorTableData		*colorTableData);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_SetType(
	TQ3ColorTableObject			colorTable,
	TQ3ColorTableType			colorTableType);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_GetType(
	TQ3ColorTableObject			colorTable,
	TQ3ColorTableType			*colorTableType);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_SetTransparent(
	TQ3ColorTableObject			colorTable,
	TQ3Boolean					hasTransparent);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_GetTransparent(
	TQ3ColorTableObject			colorTable,
	TQ3Boolean					*hasTransparent);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_SetColors(
	TQ3ColorTableObject			colorTable,
	unsigned long				startIndex,
	unsigned long				count,
	const TQ3ColorRGB32			*colors);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ColorTable_GetColors(
	TQ3ColorTableObject			colorTable,
	unsigned long				startIndex,
	unsigned long				count,
	TQ3ColorRGB32				*colors);

QD3D_EXPORT void QD3D_CALL Q3ColorRGB32_Set(
	TQ3ColorRGB32				*colorRGB32,
	unsigned char				r,
	unsigned char				g,
	unsigned char				b);

QD3D_EXPORT void QD3D_CALL Q3ColorRGB32_Get(
	TQ3ColorRGB32				colorRGB32,
	unsigned char				*r,
	unsigned char				*g,
	unsigned char				*b);
