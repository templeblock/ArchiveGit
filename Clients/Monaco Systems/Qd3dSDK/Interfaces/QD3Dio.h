 ...
 */
typedef void (QD3D_CALLBACK *TQ3DataDeleteMethod)(
	void				*data);

QD3D_EXPORT TQ3Status QD3D_CALL Q3View_SubmitWriteData(
	TQ3ViewObject		view,
	TQ3Size				size,	
	void				*data,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3File_AddIncludeFilter(
	TQ3FileObject		file,
	TQ3ObjectType		includeType);

QD3D_EXPORT TQ3Status QD3D_CALL Q3File_AddExcludeFilter(
	TQ3FileObject		file,
	TQ3ObjectType		excludeType);

QD3D_EXPORT TQ3Status QD3D_CALL Q3File_ClearFilters(
	TQ3FileObject		file);
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_SetBackgroundShader(
	TQ3ViewHintsObject		viewHints,
	TQ3ShaderObject			backgroundShader);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_GetBackgroundShader(
	TQ3ViewHintsObject		viewHints,
	TQ3ShaderObject			*backgroundShader);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_SetAtmosphericShader(
	TQ3ViewHintsObject		viewHints,
	TQ3ShaderObject			atmospheric);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_GetAtmosphericShader(
	TQ3ViewHintsObject		viewHints,
	TQ3ShaderObject			*atmospheric);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_SetGlobalTime(
	TQ3ViewHintsObject		viewHints,
	float					time);
	
QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_GetGlobalTime(
	TQ3ViewHintsObject		viewHints,
	float					*time);

QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_SetAnimationDuration(
	TQ3ViewHintsObject		viewHints,
	float					duration);
	
QD3D_EXPORT TQ3Status QD3D_CALL Q3ViewHints_GetAnimationDuration(
	TQ3ViewHintsObject		viewHints,
	float					*duration);
