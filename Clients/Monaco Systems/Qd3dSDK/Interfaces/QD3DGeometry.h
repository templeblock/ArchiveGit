...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Cone_SetParameterLimits(
	TQ3GeometryObject		cone,
	const float				uMin,
	const float				uMax,
	const float				vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Cone_GetParameterLimits(
	TQ3GeometryObject		cone,
	float					*uMin,
	float					*uMax,
	float					*vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Cone_SetInteriorAttributeSet(
	TQ3GeometryObject		cone,
	TQ3AttributeSet			interiorAttributeSet);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Cone_GetInteriorAttributeSet(
	TQ3GeometryObject		cone,
	TQ3AttributeSet			*interiorAttributeSet);
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Cylinder_SetParameterLimits(
	TQ3GeometryObject		cylinder,
	const float				uMin,
	const float				uMax,
	const float				vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Cylinder_GetParameterLimits(
	TQ3GeometryObject		cylinder,
	float					*uMin,
	float					*uMax,
	float					*vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Cylinder_SetInteriorAttributeSet(
	TQ3GeometryObject		cylinder,
	TQ3AttributeSet			interiorAttributeSet);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Cylinder_GetInteriorAttributeSet(
	TQ3GeometryObject		cylinder,
	TQ3AttributeSet			*interiorAttributeSet);
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Disk_SetParameterLimits(
	TQ3GeometryObject		disk,
	const float				uMin,
	const float				uMax,
	const float				vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Disk_GetParameterLimits(
	TQ3GeometryObject		disk,
	float					*uMin,
	float					*uMax,
	float					*vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipse_SetParameterLimits(
	TQ3GeometryObject		ellipse,
	const float				uMin,
	const float				uMax);
							
QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipse_GetParameterLimits(
	TQ3GeometryObject		ellipse,
	float					*uMin,
	float					*uMax);
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipsoid_SetParameterLimits(
	TQ3GeometryObject		ellipsoid,
	const float				uMin,
	const float				uMax,
	const float				vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipsoid_GetParameterLimits(
	TQ3GeometryObject		ellipsoid,
	float					*uMin,
	float					*uMax,
	float					*vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipsoid_SetCaps(
	TQ3GeometryObject		ellipsoid,
	TQ3EndCap				caps);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipsoid_GetCaps(
	TQ3GeometryObject		ellipsoid,
	TQ3EndCap				*caps);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipsoid_SetInteriorAttributeSet(
	TQ3GeometryObject		ellipsoid,
	TQ3AttributeSet			interiorAttributeSet);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Ellipsoid_GetInteriorAttributeSet(
	TQ3GeometryObject		ellipsoid,
	TQ3AttributeSet			*interiorAttributeSet);
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Torus_SetParameterLimits(
	TQ3GeometryObject		torus,
	const float				uMin,
	const float				uMax,
	const float				vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Torus_GetParameterLimits(
	TQ3GeometryObject		torus,
	float					*uMin,
	float					*uMax,
	float					*vMin,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3Torus_SetCaps(
	TQ3GeometryObject		torus,
	TQ3EndCap				caps);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Torus_GetCaps(
	TQ3GeometryObject		torus,
	TQ3EndCap				*caps);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Torus_SetInteriorAttributeSet(
	TQ3GeometryObject		torus,
	TQ3AttributeSet			interiorAttributeSet);

QD3D_EXPORT TQ3Status QD3D_CALL Q3Torus_GetInteriorAttributeSet(
	TQ3GeometryObject		torus,
	TQ3AttributeSet			*interiorAttributeSet);
