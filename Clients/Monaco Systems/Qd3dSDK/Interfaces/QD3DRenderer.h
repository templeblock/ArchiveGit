 ...
 */
QD3D_EXPORT TQ3Status QD3D_CALL Q3Renderer_Flush(
	TQ3RendererObject		renderer,
	TQ3ViewObject			view);
 ...
 */
QD3D_EXPORT TQ3Status QD3D_CALL Q3Renderer_Sync(
	TQ3RendererObject		renderer,
	TQ3ViewObject			view);
 ...
 */
QD3D_EXPORT TQ3Status QD3D_CALL Q3Renderer_DeleteCaches(
	TQ3RendererObject		renderer);
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3XDrawRegion_LookupColor(
	TQ3XDrawRegion	drawRegion,
	float			red,
	float			green,
	float			blue,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3XDrawRegion_PutPixel(
	TQ3XDrawRegion	drawRegion,
	unsigned long	x,
	unsigned long	y,
	float			red,
...
QD3D_EXPORT TQ3Status QD3D_CALL Q3XDrawRegion_PutRaster(
	TQ3XDrawRegion		drawRegion,
	unsigned long		x,
	unsigned long		y,
	unsigned long		width,
	unsigned long		height,
	const TQ3ColorARGB	*raster);
...
/*
 *	kQ3XMethodTypeRendererStartCache
 *	TQ3XRendererStartCacheMethod
 *	
 ...
 *	OPTIONAL
 */
#define kQ3XMethodTypeRendererStartCache	\
	Q3_METHOD_TYPE('r','d','b','c')
typedef TQ3Boolean (QD3D_CALLBACK *TQ3XRendererStartCacheMethod)(
	TQ3ViewObject			view,
	void					*rendererPrivate,
	void					*rendererCache);

/*
 *	kQ3XMethodTypeRendererEndCache
 *	TQ3XRendererEndCacheMethod
 *	
 ...
 *	OPTIONAL
 */
#define kQ3XMethodTypeRendererEndCache	\
	Q3_METHOD_TYPE('r','d','e','c')
typedef void *(QD3D_CALLBACK *TQ3XRendererEndCacheMethod)(
	TQ3ViewObject			view,
	void					*rendererPrivate);

/*
 *	kQ3XMethodTypeRendererDeleteCache
 *	TQ3XRendererDeleteCacheMethod
 *	
 ...
 *	OPTIONAL
 */
#define kQ3XMethodTypeRendererDeleteCache \
	Q3_METHOD_TYPE('r','d','d','c')
typedef TQ3Status (QD3D_CALLBACK *TQ3XRendererDeleteCacheMethod)(
	TQ3RendererObject		renderer,
	void					*rendererPrivate,
	void					*rendererCache);
