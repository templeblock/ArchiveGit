 ...
 *		{
 *			return Q3XObjectHierarchy_GetObjectType(gGeometryClass, object);
 *		}
 *
 ...
 */ 
QD3D_EXPORT TQ3ObjectType QD3D_CALL Q3XObjectClass_GetSubClassType(
	TQ3XObjectClass			objectClass,
	TQ3XObjectClass			targetObjectClass);

QD3D_EXPORT TQ3ObjectType QD3D_CALL Q3XObject_GetSubClassType(
	TQ3XObjectClass			objectClass,
 ...
 *	the Q3XObjectHierarchy_RegisterClass call.
 *	
 *	If methodsSize was zero, NULL is always returned.
 */
QD3D_EXPORT void *QD3D_CALL Q3XObject_GetClassPrivate(
	TQ3XObjectClass			objectClass,
	TQ3Object				targetObject);

QD3D_EXPORT void *QD3D_CALL Q3XObjectClass_GetClassPrivate(
	TQ3XObjectClass			objectClass,
	TQ3XObjectClass			targetObjectClass);

/*
 * Return a pointer to an object's private data structure.
 */
QD3D_EXPORT void *QD3D_CALL Q3XObject_Peek(
	TQ3Object 		object);
