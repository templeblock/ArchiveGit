...
LPSTR FindString( LPSTR lpString, LPSTR lpSearchString, BOOL bPrefixOnly = NO );
LPSTR FindPrefix( LPSTR lpString, LPSTR lpSearchString );
...
PDIB TextToDib (LPSTR lpString, LPSTR lpFaceName, int iPtSize, BOOL bItalic, COLORREF TextColor, HPALETTE hPal, COLORREF BackgrndColor = RGB(255,255,255));
...
double ScaleToFit( LPINT DestWidth, LPINT DestHeight,
                     int SrcWidth, int SrcHeight, BOOL bUseSmallerFactor = TRUE);
BOOL PointMappedToLine( long XA, long YA, long XB, long YB, 
					    long XC, long YC, LPLONG XI, LPLONG YI, LPLONG LAI, LPDOUBLE lpRate);
BOOL PointOnLine( long XA, long YA, long XB, long YB, long XC, long YC);
