...
#define HANDLE_WM_VIDEO_MSG(hwnd, wParam, lParam, fn) \
	((LRESULT)(fn)(hwnd, (UINT)WM_VIDEO_MSG, wParam, lParam))
...
//************************************************************************
{
	...
	// Don't want the app background to paint in between scenes
	GetApp()->m_bAppNoErase = m_bSceneNoErase = m_bNoErase;
	GetApp()->ResetJoyMap();
	DialogEnd( hWnd, TRUE );
}
...
/***********************************************************************/
void CScene::OnLButtonDown(HWND hWindow, BOOL fDoubleClick, int x, int y, UINT keyFlags)
/***********************************************************************/
{
}

/***********************************************************************/
void CScene::OnMouseMove(HWND hWindow, int x, int y, UINT keyFlags)
/***********************************************************************/
{
}

/***********************************************************************/
void CScene::OnDropFiles(HWND hWnd, HDROP hDrop)
/***********************************************************************/
{
}
...
/***********************************************************************/
BOOL CScene::OnVideoMsg( HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam )
/***********************************************************************/
{
	return (FALSE);
}
...
//************************************************************************
{
	...
	#ifdef USE_WINTOON
	if (GetToon())
		GetToon()->OnAppActivate(fActivate);
	#endif
	if (fActivate)
	{
		if (!m_idAnimatorTimer)
...
/***********************************************************************/
{
	...
	switch (msg)
	{
		...
		HANDLE_DLGMSG(hDlg, WM_DROPFILES, OnDropFiles);
		#ifdef _DEBUG
        ...
        HANDLE_DLGMSG(hDlg, WM_VIDEO_MSG, OnVideoMsg);
