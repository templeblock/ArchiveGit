...
!MESSAGE 
!MESSAGE NMAKE /f "Wavmix32.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/Wavmix32.dll $(OUTDIR)/Wavmix32.bsc
...
CPP_PROJ=/nologo /MT /W3 /GX /YX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"Wavmix32.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"WAVEMIX.res" /d "NDEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"Wavmix32.bsc" 
BSC32_SBRS= \
	$(INTDIR)/WAVEMIX.SBR

$(OUTDIR)/Wavmix32.bsc : $(OUTDIR)  $(BSC32_SBRS)
    $(BSC32) @<<
...
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /SUBSYSTEM:windows /DLL /INCREMENTAL:no /PDB:$(OUTDIR)/"Wavmix32.pdb"\
 /MACHINE:I386 /DEF:".\WAVMIX32.DEF" /OUT:$(OUTDIR)/"Wavmix32.dll"\
 /IMPLIB:$(OUTDIR)/"Wavmix32.lib" 
DEF_FILE=.\WAVMIX32.DEF
LINK32_OBJS= \
	$(INTDIR)/WAVEMIX.OBJ \
	$(INTDIR)/WAVEMIX.res

$(OUTDIR)/Wavmix32.dll : $(OUTDIR)  $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CPP_PROJ=/nologo /MT /W3 /GX /Zi /YX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /FR$(INTDIR)/ /Fp$(OUTDIR)/"Wavmix32.pch" /Fo$(INTDIR)/\
 /Fd$(OUTDIR)/"Wavmix32.pdb" /c 
CPP_OBJS=.\WinDebug/
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
RSC_PROJ=/l 0x409 /fo$(INTDIR)/"WAVEMIX.res" /d "_DEBUG" 
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"Wavmix32.bsc" 
...
LINK32_FLAGS=winmm.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /NOLOGO\
 /SUBSYSTEM:windows /DLL /INCREMENTAL:yes /PDB:$(OUTDIR)/"Wavmix32.pdb" /DEBUG\
 /MACHINE:I386 /DEF:".\WAVMIX32.DEF" /OUT:$(OUTDIR)/"Wavmix32.dll"\
 /IMPLIB:$(OUTDIR)/"Wavmix32.lib" 
DEF_FILE=.\WAVMIX32.DEF
LINK32_OBJS= \
...
$(INTDIR)/WAVEMIX.OBJ :  $(SOURCE)  $(DEP_WAVEM) $(INTDIR)
...
$(INTDIR)/WAVEMIX.res :  $(SOURCE)  $(INTDIR)
   $(RSC) $(RSC_PROJ)  $(SOURCE) 
