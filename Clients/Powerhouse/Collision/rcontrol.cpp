...
/***********************************************************************/
static BOOL Radar_OnEraseBkgnd(HWND hWindow, HDC hDC)
/***********************************************************************/
{
	return(TRUE);
}
...
/***********************************************************************/
{
	...
	int iZoomFactor = App.pGame->lpWorld->GetZoomFactor( CONTROL ? -1 : +1 );
...
/***********************************************************************/
{
	switch ( message )
	{
		...
		HANDLE_MSG(hWindow, WM_ERASEBKGND, Radar_OnEraseBkgnd);
