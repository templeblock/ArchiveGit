...
<xsl:stylesheet version="1.0"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="product-path" select="'../content/'" />
	...
	<xsl:template match="/thumbs">
		<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
			<head>
				...
				<style type="text/css">
					body
						{ font-family:Verdana,sans-serif; font-size:8pt; margin:0px; padding:3px; background-color:#ffffff; border:6px solid #cccccc;}
					img
						{ border-width: 0px; }
					.thumb
						{ background-color:#E2E7EE; margin:3px; padding:6px; width:180px; height:194px; float:left; text-align:center; }
					.label
						{ font-family:Verdana,sans-serif; font-size:11px; font-weight: bold; color:#1A4C8F;  margin:5px; }
				</style>
				...
				<script language="javascript">
					...
					function OnThumb(product, pw, ph, name, verse)
					{
						...
						strOptions += 'productpath=' + 'content/' + amp;
