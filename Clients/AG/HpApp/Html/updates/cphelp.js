...
function WriteTopic()
{
	...
	if (topic == '' || topic == '0')
	{
		...
		<a href="javascript:GoToTopic(\'10\')">Do I have an HP borderless-capable printer?</a><br /> \
		';
	}
	else if (topic == '1')
	{
	...
	else if (topic == '23')
	{
		...
		<br /> \
		To determine if you have an HP borderless-capable printer, <a href="javascript:GoToTopic(\'10\')">click here to view a list of printers</a>. \
		</p> \
		';
	}
	else if (topic == '24')
