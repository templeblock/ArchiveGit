/******************************************************************************
 *
 * MOIMStar.C - Minerva MDI IMStar expand
 *
...
static void OpenInitIMStar(void);
static void InitOpenIMStar3Plus(void);
static BOOL OpenIMStar(
    HWND                   hWnd,
...
static BOOL ExtractDibOpenIMStar(
    const BYTE PICHUGE*    pSrc,
    DWORD                  dwSrcLen,
    const PIC_PARM PICFAR* pSrcPicParm,
    BYTE PICHUGE* PICFAR*  ppDib,
    DWORD PICFAR*          pdwDibLen,
    PIC_PARM PICFAR*       pDibPicParm);
static BOOL OptionsDialogOpenIMStar(
    HWND                   hWnd,
    const BYTE PICHUGE*    pSrc,
    DWORD                  dwSrcLen,
    const PIC_PARM PICFAR* pSrcPicParm,
    ...
    PIC_PARM PICFAR*       pDibPicParm,
    VOID PICFAR* PICFAR*   ppOpenData);
static void PropertiesDialogOpenIMStar(
    HWND                   hWnd,
    LPCSTR                 pszFilename,
    const BYTE PICHUGE*    pSrc,
    DWORD                  dwSrcLen,
...
static void DefaultsDialogOpenIMStar(void);
static void CleanupOpenIMStar(
    BYTE PICHUGE*    pDib,
    PIC_PARM PICFAR* pDibPicParm,
    VOID PICFAR*     pOpenData);

static BOOL ExpandIMStarInWindow(
    HWND                   hWnd,
    const BYTE PICHUGE*    pSrc,
    DWORD                  dwSrcLen,
    const PIC_PARM PICFAR* pSrcPicParm,
...
static char szOptionsSection[] = "IMStar Expand Options";
...
static CTRLINITDATA InitOptionsData[] =
    ...
    */
    ...
    { "Make Gray",             eCheckBox, IDC_OLLOPT_CHECK_MAKEGRAY,            FALSE },
    { "Dither",                eCheckBox, IDC_OLLOPT_CHECK_DITHER,              TRUE  },
    { "Image Settings",	   	   eCheckBox, IDC_OLLOPT_CHECK_IMAGESETTINGS,       TRUE  },

    { szBitsPerPixel, eRadioButton, IDC_OLLOPT_RADIO_32BITS,          FALSE, 0, "32"   },
    { szBitsPerPixel, eRadioButton, IDC_OLLOPT_RADIO_24BITS,          TRUE,  0, "24"   },
    { szBitsPerPixel, eRadioButton, IDC_OLLOPT_RADIO_16BITS,          FALSE, 0, "16"   },
    { szBitsPerPixel, eRadioButton, IDC_OLLOPT_RADIO_8BITS,           FALSE, 0, "8"    },
    { szBitsPerPixel, eRadioButton, IDC_OLLOPT_RADIO_4BITS,           FALSE, 0, "4"    },
    { szBitsPerPixel, eRadioButton, IDC_OLLOPT_RADIO_1BITS,           FALSE, 0, "1"    },
    { szColorPalette, eRadioButton, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, TRUE,  0, "Embedded" },
    { szColorPalette, eRadioButton, IDC_OLLOPT_RADIO_MAKEPALETTE,     FALSE, 0, "Make",    },
    { szColorPalette, eRadioButton, IDC_OLLOPT_RADIO_EXTERNALPALETTE, FALSE, 0, "External" },

    { "External Palette Filename",   eEdit, IDC_OLLOPT_EDIT_EXTERNALPALETTE, FALSE, _MAX_PATH },
    { "Make Gray Grays To Make",     eEdit, IDC_OLLOPT_EDIT_GRAYSTOMAKE,     FALSE, 3, "256" },
    { "Make Palette Colors To Make", eEdit, IDC_OLLOPT_EDIT_COLORSTOMAKE,    FALSE, 3, "256" },
    { "Password",                    eEdit, IDC_OLLOPT_EDIT_PASSWORD,        TRUE,  8 },

    { 0, ePushButton, IDC_OLLOPT_BUTTON_BROWSE          },
    { 0, ePushButton, IDTEST                            },
    { 0, eGroupBox,   IDC_OLLOPT_STATIC_COLORPALETTE    },
    { 0, eText,       IDC_OLLOPT_STATIC_COLORS          },
    { 0, eText,       IDC_OLLOPT_STATIC_EXTERNALPALETTE },
    { 0, eText,       IDC_OLLOPT_STATIC_GRAYS           },
    { 0, eCheckBox,   IDC_OLLOPT_CHECK_SETDEFAULT       },
...
static CTRLINITDATA InitPropertiesData[] =
    {
    { 0, eText, IDC_LLPROP_FILENAME,                  0, _MAX_PATH },
    { 0, eText, IDC_LLPROP_FILESIZE,                  0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_IMAGEWIDTH_SOURCE,         0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_IMAGEHEIGHT_SOURCE,        0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_BITSPERPIXEL_SOURCE,       0, 2 },
    { 0, eText, IDC_LLPROP_IMAGESIZE_SOURCE,          0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_COLORTABLESIZE_SOURCE,     0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_NUMBERIMPORTANT_SOURCE,    0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_IMAGEWIDTH_DISPLAYED,      0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_IMAGEHEIGHT_DISPLAYED,     0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_BITSPERPIXEL_DISPLAYED,    0, 2 },
    { 0, eText, IDC_LLPROP_IMAGESIZE_DISPLAYED,       0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_COLORTABLESIZE_DISPLAYED,  0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_NUMBERIMPORTANT_DISPLAYED, 0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_PICVERSION,                0, sizeof("4,000,000,000") },
    { 0, eText, IDC_LLPROP_VISUALORIENTATION,         0, sizeof("270* clockwise, then inverted") },
    { 0, eText, IDC_LLPROP_COMPRESSIONRATIO, 0, sizeof("4,000,000,000:1") },
    { 0, eText, IDC_LLPROP_METHOD,           0, sizeof("PIC2 Continuous Tone") },
    { 0, eText, IDC_LLPROP_ERRORLIMIT,       0, sizeof("4,000,000,000") },
    { 0, eEdit, IDC_LLPROP_SCRIPT,           FALSE, MAX_COMMENT },
    { 0, eEdit, IDC_LLPROP_WATERMARK,        FALSE, MAX_COMMENT },
    { 0, eEdit, IDC_LLPROP_COMMENT,          FALSE, MAX_COMMENT },
    { 0, eEdit, IDC_LLPROP_APP,              FALSE, MAX_COMMENT },

    { 0, eText, IDC_LLPROP_PAGENUMBER,            0, sizeof("65535") },
    { 0, eText, IDC_LLPROP_TOTALPAGES,            0, sizeof("65535") },
    { 0, eText, IDC_LLPROP_TRANSPARENTCOLORINDEX, 0, sizeof("255") },
    { 0, eText, IDC_LLPROP_LEFTOFFSET,            0, sizeof("65535") },
    { 0, eText, IDC_LLPROP_TOPOFFSET,             0, sizeof("65535") },
    { 0, eText, IDC_LLPROP_DELAY,                 0, sizeof("65535") },
    { 0, eText, IDC_LLPROP_DISPOSITION,           0, sizeof("255") },
...
static DWORD arTypes[]  = { BI_LJPG, BI_PC2L, (DWORD)-1 };
static DWORD arTypes3[] = { BI_LJPG, BI_JPGL, BI_PC2L, (DWORD)-1 };

OPENOP OpenDefIMStar =
    {
    OP_LIE,
    "IMStar Versions 1 & 2 Expand",
    0,
    0,
    arTypes,
    OpenInitIMStar,
    OpenIMStar,
    ExtractDibOpenIMStar,
    OptionsDialogOpenIMStar,
    PropertiesDialogOpenIMStar,
    0,
    CleanupOpenIMStar,
    0,
    &SaveDefIMStar,
...
OPENOP OpenDefIMStar3 =
    {
    OP_LIE3,
    "IMStar Version 3 Expand",
    "IMStar Defaults",
    "IMStar (*.pic)|*.PIC|",
    arTypes3,
    0,
...
OPENOP OpenDefIMStar3Plus =
    {
    OP_LIE3PLUS,
    "Enhanced IMStar Version 3 Expand",
    0,
    0,
    arTypes3,
    InitOpenIMStar3Plus,
...
static void OpenInitIMStar(void)
{
    if ( OpenDefIMStar3.nFoundParmVer == 0 )
    {
        OpenDefIMStar.pszDefaultsMenu = OpenDefIMStar3.pszDefaultsMenu;
        OpenDefIMStar.pszFilter = OpenDefIMStar3.pszFilter;
        OpenDefIMStar.pfnDefaultsDialog = OpenDefIMStar3.pfnDefaultsDialog;
    }
}
...
static void InitOpenIMStar3Plus(void)
{
    OpenDefIMStar3Plus.pszFilter = OpenDefIMStar3.pszFilter;
    OpenDefIMStar3Plus.pszDefaultsMenu = OpenDefIMStar3.pszDefaultsMenu;
    OpenDefIMStar3Plus.pfnDefaultsDialog = OpenDefIMStar3.pfnDefaultsDialog;
    if ( OpenDefIMStar3.nFoundParmVer != 0 )
        PegasusUnload(OpenDefIMStar3.lOpcode, CURRENT_PARMVER);
	memcpy(&OpenDefIMStar3, &OpenDefIMStar3Plus, sizeof(OpenDefIMStar3));
    memset(&OpenDefIMStar3Plus, '\0', sizeof(OpenDefIMStar3Plus));
}



/******************************************************************************
 *  BOOL ExpandIMStarInWindow(
 *      HWND                   hWnd,
 *      const BYTE PICHUGE*    pSrc,
 *      DWORD                  dwSrcLen,
 *      const PIC_PARM PICFAR* pSrcPicParm,
 ...
 *      VOID PICFAR*           pOpenData)
 * 
 *  all the open sequential IMStar interesting stuff
 *
 *  parameters:
    ...
    VOID PICFAR*           pOpenData)
{
    ...
    */
    ...
    if ( pSrcPicParm->Head.biCompression == BI_JPGL || pSrcPicParm->PicVer >= 310 )
    {
		pp->Op = OpenDefIMStar3.lOpcode;
        pp->ParmVerMinor = 2;
    }
    else
    {
    ...
    /* there aren't any IMStar-specific image options except for ImageNumber
        which isn't implemented correctly in the current release (although
        there also aren't any multi-image files presently) */
    if ( pp->ParmVerMinor < 2 )
    {
        pp->Comment = MiscGlobalAllocPtr(MAX_COMMENT, IDS_IMAGEOUTOFMEMORY);
        if ( pp->Comment == 0 )
            return ( FALSE );
        pp->CommentSize = MAX_COMMENT;
        pp->u.LL.OverText = MiscGlobalAllocPtr(MAX_COMMENT, IDS_IMAGEOUTOFMEMORY);
        if ( pp->u.LL.OverText == 0 )
            {
            CleanupOpenIMStar(0, pp, 0);
            return ( FALSE );
            }
        pp->u.LL.OverTextSize = MAX_COMMENT;
        pp->u.LL.AppField = MiscGlobalAllocPtr(MAX_COMMENT, IDS_IMAGEOUTOFMEMORY);
        if ( pp->u.LL.AppField == 0 )
            {
            CleanupOpenIMStar(0, pp, 0);
            return ( FALSE );
            }
        pp->u.LL.AppFieldSize = MAX_COMMENT;
    }
    else    
    {
    ...
    if ( bYield )
        pp->u.LL.PicFlags |= PF_YieldGet | PF_YieldPut;
    ...
    if ( dwGetQSize == 0 || dwGetQSize >= dwSrcLen )
        ...
        pp->Get.Start  = (BYTE PICHUGE*)pSrc;
            /* cast away constness to eliminate the warning --
                ...
                practice, (although it is currently safe with IMStar expand). */
    ...
    */
    ...
    while ( ( response = PegasusReqInit(pp) ) == RES_ERR )
        ...
        if ( pp->Status == ERR_MISSING_KEY || pp->Status == ERR_INVALID_KEY )
            ...
            CtrlDataSetText(ar, IDC_OLLOPT_EDIT_PASSWORD, sz);
            }
        else
            {
            MiscGlobalFreePtr(&pGetQ);
    ...
    *ppDib = (BYTE PICHUGE*)MiscGlobalAllocPtr(*pdwDibLen, IDS_IMAGEOUTOFMEMORY);
    ...
    if ( dwPutQSize == 0 || dwPutQSize >= *pdwDibLen )
        ...
        if ( dwPutQSize < (DWORD)pp->u.LL3.StripSize )
            dwSize = pp->u.LL3.StripSize;
        else
            dwSize = dwPutQSize;
        pApp->dwTime[ALLOC] -= MiscTickCount();            
	 ...
	 VOID PICFAR*           pOpenData)
{
    ...
    *pdwDibLen = 0;
    ...
    bRefresh = FALSE;   /* assume that ExpandIMStarInWindow has left image current */
    /* apply image options for color reduction, etc by applying OP_UTL to the DIB */
    if ( !CtrlDataIsPushed(par, IDC_OLLOPT_CHECK_IMAGESETTINGS) && ToolDefUtility.nFoundParmVer != 0 )
        {        
        /* the remaining settings depend on DIB size */
        switch ( CtrlDataWhichRadio(par, IDC_OLLOPT_RADIO_32BITS) )
            {
            case IDC_OLLOPT_RADIO_32BITS:
					 dwBits = 32;
                break;
            case IDC_OLLOPT_RADIO_24BITS:
                dwBits = 24;
                break;
            case IDC_OLLOPT_RADIO_16BITS:
                dwBits = 16;
                break;
            case IDC_OLLOPT_RADIO_8BITS:
                dwBits = 8;
                break;
            case IDC_OLLOPT_RADIO_4BITS:
                dwBits = 4;
                break;
            case IDC_OLLOPT_RADIO_1BITS:
                dwBits = 1;
                break;
            default:
					 assert(FALSE);
        ...
        if ( dwBits > 8 )
            ...
            if ( dwBits != pDibPicParm->Head.biBitCount )
                ...
                bRet = Op82BitDepth(
                    dwBits,
                    CtrlDataIsPushed(par, IDC_OLLOPT_CHECK_DITHER),    // could count if dwBits == 16
        ...
        else if ( CtrlDataIsPushed(par, IDC_OLLOPT_CHECK_MAKEGRAY) )
            {
            if ( pDibPicParm->Head.biBitCount != dwBits ||
                 !MiscIsGrayPalette(pDibPicParm->Head.biClrImportant, pDibPicParm->ColorTable) )
                {
                dwNumColors = CtrlDataGetLong(par, IDC_OLLOPT_EDIT_GRAYSTOMAKE, FALSE);
                App.dwTime[PALETTE] -= MiscTickCount();
                bRet = Op82Grayscale(
                    dwBits,
                    CtrlDataIsPushed(par, IDC_OLLOPT_CHECK_DITHER),
                    dwNumColors,
                    *ppDib, *pdwDibLen, pDibPicParm,
                    &pDib,  &dwDibLen,  &pp);
                App.dwTime[PALETTE] += MiscTickCount();
        ...
        else if ( CtrlDataIsPushed(par, IDC_OLLOPT_RADIO_MAKEPALETTE) )
				{
            dwNumColors = CtrlDataGetLong(par, IDC_OLLOPT_EDIT_COLORSTOMAKE, FALSE);
            App.dwTime[PALETTE] -= MiscTickCount();
        ...
        else if ( CtrlDataIsPushed(par, IDC_OLLOPT_RADIO_EXTERNALPALETTE) )
            {
            CtrlDataGetText(par, IDC_OLLOPT_EDIT_EXTERNALPALETTE, sz, sizeof(sz));
    ...
    VOID PICFAR* PICFAR*   ppOpenData)
{
    ...
    if ( pSrcPicParm->Head.biCompression == BI_JPGL || pSrcPicParm->PicVer >= 310 )
    {
        if ( OpenDefIMStar3.nFoundParmVer == 0 && OpenDefIMStar3Plus.nFoundParmVer == 0 )
        {
            ...
            ErrorMessage(
                ...
                (LPCSTR)sz,
                (LPCSTR)OpenDefIMStar3.pszAbout,
                OpenDefIMStar3.lOpcode / 1000,
                CURRENT_PARMVER);
    ...
    {
        if ( OpenDefIMStar.nFoundParmVer == 0 )
        {
            GetWindowText(hWnd, sz, sizeof(sz));
            /* note the string resource includes printf formatting */
            ErrorMessage(
                ...
                IDS_IMAGEOPCODENOTPRESENT,
                (LPCSTR)sz,
                (LPCSTR)OpenDefIMStar.pszAbout,
                OpenDefIMStar.lOpcode / 1000,
                CURRENT_PARMVER);
            /* "The file %s requires the %s DLL (PICN%.2lu%.2u ) which was not found."
                "The image cannot be loaded." */
            return ( FALSE );
    ...
    if ( !CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_CHECK_IMAGESETTINGS) && ToolDefUtility.nFoundParmVer != 0 )
        {
        /*#### IMStar doesn't deal with 32-bit or 16-bit DIB's (and UTL doesn't convert) */
        CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_32BITS);
        CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_16BITS);
    
        /* if source image is grayscale, don't let the user change color palette choices
            in the image options dialog box */
        if ( ( pSrcPicParm->Head.biCompression == BI_JPGL &&
               pSrcPicParm->Head.biBitCount == 8 ) ||
             MiscIsGrayPalette(pSrcPicParm->Head.biClrImportant, pSrcPicParm->ColorTable) )
            {
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_STATIC_COLORPALETTE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_32BITS);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_24BITS);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_16BITS);

            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_MAKEPALETTE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_EXTERNALPALETTE);
        
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_EDIT_COLORSTOMAKE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_STATIC_COLORS);
        
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_STATIC_EXTERNALPALETTE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_EDIT_EXTERNALPALETTE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_BUTTON_BROWSE);

            /* and make sure either 4-bit or 8-bit bit depth is pushed and
                that make gray is pushed */
            if ( !CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_4BITS) &&
                 !CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_1BITS) )
                CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_RADIO_8BITS, TRUE);
            CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_CHECK_MAKEGRAY, TRUE);
            CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_CHECK_MAKEGRAY);
            }
        else
            {
            ...
            if ( ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_8BITS) ||
                   CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_4BITS) ||
                   CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_1BITS) ) &&
                 !CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_CHECK_MAKEGRAY) )
                {
                if ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_8BITS) )
                    nColors = 256;
                else if ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_4BITS) )
                    nColors = 16;
                else
                    nColors = 2;
                ...
                CtrlDataGetText(*ppOpenData, IDC_OLLOPT_EDIT_EXTERNALPALETTE, sz, sizeof(sz));
                ...
                if ( ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) &&
                       ( lPrimaryColors < 2 || lPrimaryColors > nColors ) &&
                       ( lSecondaryColors < 2 || lSecondaryColors > nColors ) ) ||
                     ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_EXTERNALPALETTE) &&
                    ...
                    CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_RADIO_MAKEPALETTE, TRUE);
                    CtrlDataSetLong(*ppOpenData, IDC_OLLOPT_EDIT_COLORSTOMAKE, nColors, FALSE);
                    }
                }
            if ( CtrlDataIsInactive(*ppOpenData, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) &&
                 CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) )
                CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_RADIO_MAKEPALETTE, TRUE);
            }
        }
            ...
            case RES_GET_NEED_DATA:
                if ( ( p->Get.QFlags & Q_EOF ) != 0 )
                    ...
                    if ( pApp->dwGetLen == 0 )
                        ...
                        pApp->dwTime[MEMCPY] += MiscTickCount();
                        if ( ( p->u.LL.PicFlags & PF_YieldGet ) != 0 )
                            {                
                            pApp->dwTime[YIELD] -= MiscTickCount();
                            if ( MiscYield() )
                                {
    ...
    while ( response != RES_DONE )
        ...
        switch ( response )
            ...
            case RES_PUT_NEED_SPACE:
                pApp->dwTime[MEMCPY] -= MiscTickCount();
                MiscCopyFromQueue(&pApp->pPut, &pApp->dwPutSize, &p->Put, p->u.LL3.StripSize);
                pApp->dwTime[MEMCPY] += MiscTickCount();
                if ( ( p->u.LL.PicFlags & PF_YieldPut ) != 0 )
                    {
                    pApp->dwTime[PAINT] -= MiscTickCount();
    ...
    VOID PICFAR* PICFAR*   ppOpenData)
{
    ...
    result = DlgDoModal(hwndFrame, MAKEINTRESOURCE(IDD_OLLOPT), ImageOnCommand, *ppData, &oud);
        ...
        if ( oud.bTested )
            ...
            *ppData = pOldData;
            ...
            if ( ExpandImageInWindow(     
                    ...
                    pDibPicParm,
                    *ppData) )
                CleanupOpenIMStar(pOldDib, &OldDibPicParm, 0);
            else                
                assert(FALSE);
    ...
    if ( CtrlDataIsPushed(*ppData, IDC_OLLOPT_CHECK_SETDEFAULT) )
...
/******************************************************************************
 *  void PropertiesDialogOpenIMStar
 *      LPCSTR                 pszFilename,
 *      const BYTE PICHUGE*    pSrc,
 *      DWORD                  dwSrcLen,
 *      const PIC_PARM PICFAR* pSrcPicParm,
...
static void PropertiesDialogOpenIMStar(
    ...
    const VOID PICFAR*     pOpenData)
{
    char sz[_MAX_PATH + sizeof(" Lossless JPEG Properties")];
    int result;
    ...
    */
    ...
    CtrlDataSetText(pInitData, IDC_LLPROP_FILENAME, sz);
    CtrlDataSetLong(pInitData, IDC_LLPROP_FILESIZE, dwSrcLen, FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_IMAGEWIDTH_SOURCE, pSrcPicParm->Head.biWidth, FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_IMAGEHEIGHT_SOURCE, labs(pSrcPicParm->Head.biHeight), FALSE);
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_BITSPERPIXEL_SOURCE,
    ...
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_IMAGESIZE_SOURCE,
        dwSrcWidthPad * labs(pSrcPicParm->Head.biHeight),
        FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_COLORTABLESIZE_SOURCE, pSrcPicParm->Head.biClrUsed, FALSE);
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_NUMBERIMPORTANT_SOURCE,
        pSrcPicParm->Head.biClrImportant,
        FALSE);

    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_IMAGEWIDTH_DISPLAYED,
        pDibPicParm->Head.biWidth,
        FALSE);
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_IMAGEHEIGHT_DISPLAYED,
        pDibPicParm->Head.biHeight,
        FALSE);
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_BITSPERPIXEL_DISPLAYED,
        pDibPicParm->Head.biBitCount,
        FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_IMAGESIZE_DISPLAYED, dwDibLen, FALSE);
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_COLORTABLESIZE_DISPLAYED,
        pDibPicParm->Head.biClrUsed,
        FALSE);
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_NUMBERIMPORTANT_DISPLAYED,
        pDibPicParm->Head.biClrImportant,
        FALSE);

    CtrlDataSetLong(pInitData, IDC_LLPROP_PICVERSION, pSrcPicParm->PicVer, FALSE);
    CtrlDataSetText(
        pInitData,
        IDC_LLPROP_VISUALORIENTATION,
    ...
    CtrlDataSetLong(
        pInitData,
        IDC_LLPROP_COMPRESSIONRATIO,
        ( dwSrcBmpSize + dwSrcLen / 2 ) / dwSrcLen,
        FALSE);
    CtrlDataGetText(pInitData, IDC_LLPROP_COMPRESSIONRATIO, sz, sizeof(sz));
    strcat(sz, ":1");
    CtrlDataSetText(pInitData, IDC_LLPROP_COMPRESSIONRATIO, sz);

    if ( pSrcPicParm->Head.biCompression == BI_JPGL )
        CtrlDataSetText(pInitData, IDC_LLPROP_METHOD, "Lossless JPEG");
    else if ( pDibPicParm->u.LL.CompMethod == 'J' )
        CtrlDataSetText(pInitData, IDC_LLPROP_METHOD, "PIC2 Continuous Tone");
    else
        {
        assert(pDibPicParm->u.LL.CompMethod == 'P');
        wsprintf(sz, "PIC2 Discrete Order %d", pDibPicParm->u.LL.CompOrder);
        CtrlDataSetText(pInitData, IDC_LLPROP_METHOD, sz);
        }
    CtrlDataSetLong(pInitData, IDC_LLPROP_ERRORLIMIT, pDibPicParm->u.LL.ErrLimit, FALSE);

    CtrlDataSetLong(pInitData, IDC_LLPROP_PAGENUMBER, pDibPicParm->u.LL.PageNum, FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_TOTALPAGES, pDibPicParm->u.LL.NumOfPages, FALSE);
    if ( pDibPicParm->u.LL.Transparent != -1 )
        CtrlDataSetLong(
            pInitData, 
            IDC_LLPROP_TRANSPARENTCOLORINDEX, 
            pDibPicParm->u.LL.Transparent, 
            FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_LEFTOFFSET, pDibPicParm->u.LL.XOff, FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_TOPOFFSET, pDibPicParm->u.LL.YOff, FALSE);
    CtrlDataSetLong(pInitData, IDC_LLPROP_DISPOSITION, pDibPicParm->u.LL.DispMethod, FALSE);
    wsprintf(sz, "%u.%.2u", pDibPicParm->u.LL.UserDelay / 100, pDibPicParm->u.LL.UserDelay % 100);
    CtrlDataSetText(pInitData, IDC_LLPROP_DELAY, sz);


    if ( pDibPicParm->ParmVerMinor < 2 )
    {
		  if ( pDibPicParm->u.LL.OverTextLen != 0 )
				{
				LPSTR psz = (LPSTR)MiscGlobalAllocPtr(pDibPicParm->u.LL.OverTextLen, IDS_PROPERTIESOUTOFMEMORY);
				if ( psz == 0 )
					 {
					 CtrlDataFree(&pInitData);
					 return;
					 }
				lstrcpyn(psz, (LPCSTR)pDibPicParm->u.LL.OverText, MAX_COMMENT + 1);
				if ( ( pDibPicParm->u.LL.PicFlags & PF_HaveWatermark ) == 0 )
					 CtrlDataSetText(pInitData, IDC_LLPROP_SCRIPT, psz);
				else
					 CtrlDataSetText(pInitData, IDC_LLPROP_WATERMARK, psz);
		  ...
		  if ( pDibPicParm->CommentLen != 0 )
            ...
            CtrlDataSetText(pInitData, IDC_LLPROP_COMMENT, psz);
            MiscGlobalFreePtr(&psz);
            }
        if ( pDibPicParm->u.LL.AppFieldLen != 0 )
				{
				LPSTR psz = (LPSTR)MiscGlobalAllocPtr(pDibPicParm->u.LL.AppFieldLen, IDS_PROPERTIESOUTOFMEMORY);
				if ( psz == 0 )
					 {
					 CtrlDataFree(&pInitData);
					 return;
					 }
				lstrcpyn(psz, (LPSTR)pDibPicParm->u.LL.AppField, MAX_COMMENT + 1);
            CtrlDataSetText(pInitData, IDC_LLPROP_APP, psz);
				MiscGlobalFreePtr(&psz);
            }
    }
    else if ( pDibPicParm->PIC2List != 0 )
    {   /* version 3 comments, etc. */
          ...
          if ( ( pDibPicParm->u.LL.PicFlags & PF_HaveWatermark ) != 0 )
          {
    		  psz = (LPSTR)MiscAllocatePIC2Comment(pDibPicParm->PIC2List, P2P_Watermark);
	    	  if ( psz != 0 )
		    		CtrlDataSetText(pInitData, IDC_LLPROP_WATERMARK, psz);
    		  MiscGlobalFreePtr(&psz);
          }
		  psz = (LPSTR)MiscAllocatePIC2Comment(pDibPicParm->PIC2List, P2P_Script);
		  if ( psz != 0 )
				CtrlDataSetText(pInitData, IDC_LLPROP_SCRIPT, psz);
		  MiscGlobalFreePtr(&psz);
    ...
    */
    GetWindowText(hWnd, sz, sizeof(sz) - ( sizeof(" Lossless JPEG Properties") - 1 ));
    if ( pDibPicParm->u.LL3.CompMethod == 'S' )
        strcat(sz, " Lossless JPEG");
    else
        strcat(sz, " IMStar");
    strcat(sz, " Properties");
    result = DlgDoModal(
        hwndFrame,
        MAKEINTRESOURCE(IDD_LLPROP),
        PropertiesOnCommand,
        pInitData,
        sz);
    CtrlDataFree(&pInitData);
 ...
 *      pUserData   - as defined by OpenIMStar
 *
 *  returns:
...
/******************************************************************************
 *  void DefaultsDialogOpenIMStar(void)
 *
...
void DefaultsDialogOpenIMStar(void)
{
    ...
    CtrlDataSetInactive(pOpenData, IDC_OLLOPT_RADIO_32BITS);
    CtrlDataSetInactive(pOpenData, IDC_OLLOPT_RADIO_16BITS);

    CtrlDataSetPushed(pOpenData, IDC_OLLOPT_CHECK_SETDEFAULT, TRUE);
    CtrlDataSetInactive(pOpenData, IDC_OLLOPT_CHECK_SETDEFAULT);
    CtrlDataSetInactive(pOpenData, IDTEST);
    result = DlgDoModal(
        hwndFrame,
        MAKEINTRESOURCE(IDD_OLLOPT),
        DefaultsOnCommand,
        pOpenData,
        &oud);
    if ( result != IDOK )
    ...
    VOID PICFAR*     pOpenData)
{
    ...
    if ( pDibPicParm != 0 )
    {
        if ( pDibPicParm->ParmVerMinor < 2 )
        {
            ...
            MiscGlobalFreePtr(&pDibPicParm->u.LL.AppField);
            MiscGlobalFreePtr(&pDibPicParm->u.LL.OverText);
        }
        else
        {
...
static BOOL GetCtrlDefaults(LPCSTR pszSection, LPCTRLINITDATA PICFAR* ppOpenData)
{
    ...
    if ( ToolDefUtility.nFoundParmVer == 0 )
    {
    	CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_CHECK_IMAGESETTINGS, TRUE);
    	CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_CHECK_IMAGESETTINGS);
    }
    ...
    /* if screen bit depth is <= 8, make sure default bits/pixel isn't greater */
        ...
        CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_32BITS);
        CtrlDataSetInactive(*ppOpenData, IDC_OLLOPT_RADIO_16BITS);
        if ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_32BITS) ||
             CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_16BITS) )
            CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_RADIO_24BITS, TRUE);
        if ( num < 8 )
            {
            if ( CtrlDataIsPushed(*ppOpenData, IDC_OLLOPT_RADIO_8BITS) )
                CtrlDataSetPushed(*ppOpenData, IDC_OLLOPT_RADIO_4BITS, TRUE);
            }
        }
    return ( TRUE );
}
	 ...
	 void PICFAR*    pUserData)
{
	 ...
	 switch ( nCtrlID )
		...
		case IDC_OLLOPT_CHECK_IMAGESETTINGS:
         ...
         case IDC_OLLOPT_CHECK_MAKEGRAY:
            if ( wNotifyCode == BN_CLICKED )
                {
                ...
                CheckDlgButton(
                    hwndDlg,
                    IDC_OLLOPT_CHECK_MAKEGRAY,
						  !IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY));

                /* make sure the bit depth is 8 bits or 4 bits */
                if ( !IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_4BITS) &&
                     !IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS) )
                    CheckRadioButton(
                        hwndDlg,
                        IDC_OLLOPT_RADIO_32BITS,
                        IDC_OLLOPT_RADIO_1BITS,
                        IDC_OLLOPT_RADIO_8BITS);
        ...
        case IDC_OLLOPT_RADIO_16BITS:
            if ( wNotifyCode == BN_CLICKED )
                ...
                CheckDlgButton(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY, FALSE);
                DefaultsGrayedCtrls(hwndDlg, arOpenData);
                DlgSetModified(hwndDlg);
                }
            break;
        ...
        case IDC_OLLOPT_RADIO_MAKEPALETTE:
            if ( wNotifyCode == BN_CLICKED )
                {
                /* set default colors to make according to bit depth, if not yet set */
                SetColorsToMake(hwndDlg);
        ...
        case IDC_OLLOPT_RADIO_EMBEDDEDPALETTE:
        case IDC_OLLOPT_RADIO_EXTERNALPALETTE:
            if ( wNotifyCode == BN_CLICKED )
                {
                DefaultsGrayedCtrls(hwndDlg, arOpenData);
                DlgSetModified(hwndDlg);
        ...
        case IDC_OLLOPT_BUTTON_BROWSE:
            if ( wNotifyCode == BN_CLICKED )
                ...
                /* browse for a suitable external palette file.  If the file doesn't have
                    ...
                    error */
                if ( MiscPaletteBrowse(hwndDlg, IDC_OLLOPT_EDIT_EXTERNALPALETTE, 256) )
                    DlgSetModified(hwndDlg);
                }
            break;

        case IDHELP:
            WinHelp(hwndFrame, APPLICATION_HELPFILENAME, HELP_CONTENTS, IDD_OLLOPT);
            break;
...
static BOOL DefaultOptionsValid(HWND hwndDlg)
{
    ...
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) )
        maxColors = 256;
    else if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_4BITS) )
        maxColors = 16;
    else if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS) )
        maxColors = 2;
    else
        return ( TRUE );

    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY) )
        {
        /* validate number of grays to make */
        n = GetDlgItemInt(hwndDlg, IDC_OLLOPT_EDIT_GRAYSTOMAKE, &fValid, FALSE);
        if ( !fValid || n < 2 || n > maxColors )
            ...
            SetFocus(GetDlgItem(hwndDlg, IDC_OLLOPT_EDIT_GRAYSTOMAKE));
            Edit_SetSel(GetDlgItem(hwndDlg, IDC_OLLOPT_EDIT_GRAYSTOMAKE), 0, -1);
            return ( FALSE );
            }
        }
    else
        {
        if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE) )
            {
            /* validate number of colors to make */
            n = GetDlgItemInt(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE, &fValid, FALSE);
            if ( !fValid || n < 2 || n > maxColors )
                {
                ErrorMessage(STYLE_ERROR, IDS_INVALIDNUM, 2, maxColors);
                /* "The number is invalid or out of range.  Please enter a number from 2 to %d." */
                SetFocus(GetDlgItem(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE));
                Edit_SetSel(GetDlgItem(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE), 0, -1);
                return ( FALSE );
                }
            }
        else if ( !IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) )
            {
            /* make sure external palette actually has a suitable palette */
            assert(IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EXTERNALPALETTE));
            GetDlgItemText(hwndDlg, IDC_OLLOPT_EDIT_EXTERNALPALETTE, sz, sizeof(sz));
            n = MiscPaletteColors(sz, 0, maxColors);
            if ( n == 0 )
                {
                SetFocus(GetDlgItem(hwndDlg, IDC_OLLOPT_EDIT_EXTERNALPALETTE));
                Edit_SetSel(GetDlgItem(hwndDlg, IDC_OLLOPT_EDIT_EXTERNALPALETTE), 0, -1);
                return ( FALSE );
                }
            }
        }
...
static void DefaultsGrayedCtrls(HWND hwndDlg, LPCTRLINITDATA ar)
{
	BOOL fImageSettings = IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_IMAGESETTINGS);
    BOOL fMakeGray = IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY);
    BOOL fEnableColorPalette;

	if ( fImageSettings )
	{
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_CHECK_DITHER,        FALSE);
		CtrlEnable(hwndDlg, ar, IDC_OLLOPT_CHECK_MAKEGRAY,      FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_EDIT_GRAYSTOMAKE,    FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_STATIC_GRAYS,        FALSE);

		CtrlEnable(hwndDlg, ar, IDC_OLLOPT_STATIC_BITSPERPIXEL, FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_32BITS,        FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_24BITS,        FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_16BITS,        FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_8BITS,         FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_4BITS,         FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_1BITS,         FALSE);
    ...
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) ||
         IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_4BITS) ||
         IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS) )
        {
        /* target bit depth <= 8 */

        /* enable make gray options */
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_CHECK_DITHER, TRUE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_EDIT_GRAYSTOMAKE, fMakeGray);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_STATIC_GRAYS, fMakeGray);
        ...
        /* disable bit depths > 8 if makegray is checked,
            ...
            (or hurt) */
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_32BITS, !fMakeGray);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_24BITS, !fMakeGray);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_16BITS, !fMakeGray);
        ...
        CtrlEnable(
            hwndDlg,
            ar,
            IDC_OLLOPT_CHECK_DITHER,
            IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_16BITS));
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_EDIT_GRAYSTOMAKE, FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_STATIC_GRAYS,     FALSE);
...
static BOOL ImageOnCommand(
    ...
    void PICFAR*    pUserData)
{
    char sz[_MAX_PATH + sizeof(" Lossless JPEG Open Options")];
    ...
    switch ( nCtrlID )
        ...
        case -1:    /* for WM_INITDIALOG - the virtue is it saves us having to have a separate
                        function passed to our dialog box handler */
            GetWindowText(poud->hWnd, sz, sizeof(sz) - ( sizeof(" Lossless JPEG Open Options") - 1 ));
            if ( poud->pDibPicParm->u.LL3.CompMethod == 'S' )
                strcat(sz, " Lossless JPEG Open Options");
            else
                strcat(sz, " IMStar Open Options");
        ...
        case IDC_OLLOPT_CHECK_SETDEFAULT:
...
static BOOL ImageOptionsValid(HWND hwndDlg, OPTIONSUSERDATA PICFAR* poud)
{
    ...
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) )
        ...
        assert(!IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY) &&
    ...
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY) )
        ...
        if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) )
            {
        ...
        else if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE) )
            {
            /* validate number of colors to make */
            n = GetDlgItemInt(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE, &fValid, FALSE);
            if ( !fValid || n < 2 || n > maxColors )
...
//####    long lSecondaryColors;
    ...
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) ||
        ...
        if ( fMakeGray )
            {
            CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_4BITS, TRUE);
            CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_1BITS, TRUE);
            fEnableColorPalette = FALSE;
            }
        }
    else
...
//####
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) )
        ...
        switch ( poud->pSrcPicParm->Head.biBitCount )
        {
            case 8:
                if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_4BITS) ||
                     IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS) )
                    {
                    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, FALSE);
                    CheckDlgButton(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, FALSE);
                    CheckDlgButton(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE, TRUE);
                    }
                else
                    {
                    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_8BITS, TRUE);
                    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_4BITS, FALSE);
                    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_1BITS, FALSE);
                    }
                break;
        ...
        if ( ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) &&
            ...
            CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, TRUE);
        else
            CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, FALSE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_8BITS, TRUE);
        CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_4BITS, TRUE);
...
//####
    ...
    if ( lColors > 16 )
        ...
        if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) )
            ...
            CtrlEnable(hwndDlg, 
                ar,
                IDC_OLLOPT_RADIO_EMBEDDEDPALETTE,
                FALSE);
        else
            {
            CtrlEnable(
        ...
        if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE) )
            {
            if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS) )
                {
                CheckDlgButton(hwndDlg, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, FALSE);
                CheckDlgButton(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE, TRUE);
                SetGraysToMake(hwndDlg);
...
{
    /* group box */
    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_STATIC_COLORPALETTE,   bEnabled);

    /* radio buttons */
    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_EMBEDDEDPALETTE, bEnabled);
    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_MAKEPALETTE,     bEnabled);
    CtrlEnable(hwndDlg, ar, IDC_OLLOPT_RADIO_EXTERNALPALETTE, bEnabled);

    /* make palette options */
    CtrlEnable(
        hwndDlg,
        ar,
        IDC_OLLOPT_EDIT_COLORSTOMAKE,
        bEnabled && IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE));
    CtrlEnable(
        hwndDlg,
        ar,
        IDC_OLLOPT_STATIC_COLORS,
        bEnabled && IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE));
    ...
    CtrlEnable(
        hwndDlg,
        ar,
        IDC_OLLOPT_STATIC_EXTERNALPALETTE,
        bEnabled && IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EXTERNALPALETTE));
    CtrlEnable(
        hwndDlg,
        ar,
        IDC_OLLOPT_EDIT_EXTERNALPALETTE,
        bEnabled && IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EXTERNALPALETTE));
    CtrlEnable(
        hwndDlg,
        ar,
        IDC_OLLOPT_BUTTON_BROWSE,
        bEnabled && IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_EXTERNALPALETTE));
}
...
static void SetGraysToMake(HWND hwndDlg)
{
    if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY) )
        {
        if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) )
            SetNumToMake(hwndDlg, IDC_OLLOPT_EDIT_GRAYSTOMAKE, 256);
        else if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_4BITS) )
            SetNumToMake(hwndDlg, IDC_OLLOPT_EDIT_GRAYSTOMAKE, 4);
        else
            {
            assert(IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS));
            SetNumToMake(hwndDlg, IDC_OLLOPT_EDIT_GRAYSTOMAKE, 2);
            }
        }
}
...
{
    if ( !IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_CHECK_MAKEGRAY) &&
         IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_MAKEPALETTE) )
        {
        if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_8BITS) )
            SetNumToMake(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE, 256);
        else if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_4BITS) )
            SetNumToMake(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE, 16);
        else if ( IsDlgButtonChecked(hwndDlg, IDC_OLLOPT_RADIO_1BITS) )
            SetNumToMake(hwndDlg, IDC_OLLOPT_EDIT_COLORSTOMAKE, 2);
        }
}
