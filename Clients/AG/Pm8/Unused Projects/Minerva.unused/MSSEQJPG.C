...
static CTRLINITDATA InitOptionsData[] =
    ...
    */
    ...
    { szOutputType,   eRadioButton, IDC_SSEQJPGOPT_RADIO_EXIF,            FALSE, 0, "Exif"     },
...
void InitSaveEnhancedSequentialJpeg(void)
{
    ...
    if ( SaveDefSequentialJpeg.nFoundParmVer != 0 )
        PegasusUnload(SaveDefSequentialJpeg.lOpcode, CURRENT_PARMVER);
    ...
    DWORD PICFAR*            pdwLenSaved)
{
    ...
    */
    ...
    SaveSrcPicParm.ParmVerMinor = 2;
    if ( SaveDefSequentialJpeg.nFoundParmVer == 0 )
        SaveSrcPicParm.Op = OP_D2SE;
    else
        SaveSrcPicParm.Op = OP_D2S;
    ////SaveSrcPicParm.u.D2J.ExifThumbnailToMake = THUMB_16;
    ...
    SaveSrcPicParm.u.D2J.ExifThumbnailToMake = 256;
...
static BOOL InitPicParm(PIC_PARM *pPicParm, LPCTRLINITDATA pSaveData)
{
    ...
    switch ( CtrlDataWhichRadio(pSaveData, IDC_SSEQJPGOPT_RADIO_PIC2) )
        ...
        case IDC_SSEQJPGOPT_RADIO_JFIF:
            ...
            break;
        case IDC_SSEQJPGOPT_RADIO_EXIF:
            pPicParm->u.D2S.JpegType = JT_EXIF;
            break;
        default:
            assert(FALSE);
            break;
    ...
    switch ( nCtrlID )
        ...
        case IDC_SSEQJPGOPT_RADIO_ELS:
            if ( wNotifyCode == BN_CLICKED )
                ...
                CheckDlgButton(hwndDlg, IDC_SSEQJPGOPT_RADIO_EXIF, FALSE);
    ...
    OPTIONSUSERDATA PICFAR* poud)
{
    ...
    CtrlEnable(hwndDlg, ar, IDC_SSEQJPGOPT_RADIO_EXIF,               fEnableOptions);
    ...
    if ( fEnableOptions && fEmbeddedPaletteOK && !fIsGray )
