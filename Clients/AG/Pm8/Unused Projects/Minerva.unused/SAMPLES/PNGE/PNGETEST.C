 ...
 * $Header: /PEGASUS/PNGE/PNGENNW/PNGETEST.C 4     11/03/98 6:13a Jimbean $
 * $Nokeywords: $
 */
...
*                                                                       *
*   This routine can test to see if at least p.u.PNG.MinReadData bytes  *
*   are returned.  This is the size of the next expected chunk.  If     *
*   There is not enough room in the buffer for this many bytes then the *
*   image cannot be expanded and more space will have to be allocated.  *
*                                                                       *
\***********************************************************************/
PRIVATE void   CopyFromFileToQueue (void)
{
