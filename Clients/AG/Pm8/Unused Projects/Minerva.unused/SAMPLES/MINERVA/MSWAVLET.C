...
static BOOL InitPicParm(PIC_PARM *pPicParm, LPCTRLINITDATA ar)
{
    ...
    pPicParm->u.WAVE.Y.QuantizationThreshold =
        (WORD)CtrlDataGetLong(ar, IDC_SWAVEOPT_EDIT_Y_THRESHOLD, FALSE);
    ...
    pPicParm->u.WAVE.I.QuantizationThreshold =
        (WORD)CtrlDataGetLong(ar, IDC_SWAVEOPT_EDIT_I_THRESHOLD, FALSE);
    ...
    pPicParm->u.WAVE.Q.QuantizationThreshold =
        (WORD)CtrlDataGetLong(ar, IDC_SWAVEOPT_EDIT_Q_THRESHOLD, FALSE);
