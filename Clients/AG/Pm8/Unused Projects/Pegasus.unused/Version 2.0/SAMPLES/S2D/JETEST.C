/*.T  JETEST.C
 * $Header: /PEGASUS/J2D/JE2DDDW/jetest.c 14    12/09/98 12:53p Jimbean $Nokeywords: $
 */
...
#if CNT
/* Temp! */
PUBLIC DWORD OverCt = 0, UnderCt = 0,  TotalCt = 0;
#endif
...
#if CNT
	/* Temp! */
	printf("OverCt = %d UnderCt = %d TotalCt = %d \n",OverCt,UnderCt,TotalCt);
#endif
