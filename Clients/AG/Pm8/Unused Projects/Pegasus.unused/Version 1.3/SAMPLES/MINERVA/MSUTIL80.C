    ...
    DWORD PICFAR*            pdwLenSaved)
{
    ...
    if ( CtrlDataIsPushed(pSaveData, IDC_SD2FOPTTIF_RADIO_G3) )
        d2f.Compression = 2;
            ...
            case RES_PUTQ_GET_NEED_DATA:
                ...
                {                    
                    ...
                    else
                    {
                        pApp->pPut = pApp->pPut0 + ( p->SeekInfo & SEEK_OFFSET );
                        pApp->dwPutLen = pApp->pPut0 + pApp->dwPutSize - pApp->pPut;
                        MiscCopyToQueue(&pApp->pPut, &pApp->dwPutLen, &p->Put, 0);
...
static CTRLINITDATA TIFInitOptionsData[] =
    ...
    */
    ...
    { szCompression,   eRadioButton, IDC_SD2FOPTTIF_RADIO_G3,            FALSE, 0, "G3"  },
    ...
    LPCTRLINITDATA PICFAR* ppSaveData)
{
    ...
    else if ( poud->pDibPicParm->Head.biBitCount != 1 )
    {
        ...
        CtrlDataSetInactive(*ppSaveData, IDC_SD2FOPTTIF_RADIO_G3);
