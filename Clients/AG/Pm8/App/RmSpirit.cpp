#include "stdafx.h"
#include "rmspirit.h"
#include "..\Resource\AG\Spirit\resource.h"

IMPLEMENT_DYNAMIC(CSpiritResourceManager, CSharedIDResourceManager)

UINT CSpiritResourceManager::GetResourceID(int enItem)
   {
      UINT  uiResourceID;
