#include "stdafx.h"
#include "rmcraft.h"
#include "..\Resource\AG\Craft\resource.h"

IMPLEMENT_DYNAMIC(CCraftResourceManager, CSharedIDResourceManager)

UINT CCraftResourceManager::GetResourceID(int enItem)
   {
      UINT  uiResourceID;
