...
////////////////////////////////////////////////////////////////////////////
HRESULT CXMLDocument2::LoadXML(LPCTSTR szXML, bool& bSuccess)
{
	HRESULT hr = S_FALSE;
	VARIANT_BOOL bIsSuccessful = false;
	
	if (m_pDoc)
		hr = m_pDoc->loadXML(CComBSTR(szXML), &bIsSuccessful);
	
	bSuccess = (bIsSuccessful ? true : false);
	hr = CheckHR(hr, _T("loading XML string"));
