...
template <class T>
class ATL_NO_VTABLE CPropertyPageEx : public CDialogImplBase
{
public:
// Construction
	CPropertyPageEx(LPCTSTR lpszTitle = NULL)
	{
...
// Operations
	...
	void PressButton(int iButton)
	{
		...
		::PostMessage(GetParent(), PSM_PRESSBUTTON, (WPARAM)iButton, 0);
	}
...
public:
	BEGIN_MSG_MAP(CPropertyPageEx<T>)
