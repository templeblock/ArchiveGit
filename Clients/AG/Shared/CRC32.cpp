...
static const ULONG s_arrdwCrc32Table[256] = {
...
#define DO1(buf) crc = s_arrdwCrc32Table[((int)crc ^ (*buf++)) & 0xff] ^ (crc >> 8);
...
//Pre- and post-conditioning (one's complement) is performed within this function 
//so it shouldn't be done by the application. 
//Usage example: 
...
/////////////////////////////////////////////////////////////////////////////////////
DWORD CCRC32::StringCrc32(LPCTSTR szString, DWORD &dwCrc32)
{
	dwCrc32 = 0xFFFFFFFF;
	while(*szString != _T('\0'))
	{
...
/////////////////////////////////////////////////////////////////////////////////////
DWORD CCRC32::FileCrc32Win32(LPCTSTR szFilename, DWORD &dwCrc32)
{
	_ASSERTE(szFilename);
...
/////////////////////////////////////////////////////////////////////////////////////
DWORD CCRC32::FileCrc32Assembly(LPCTSTR szFilename, DWORD &dwCrc32)
{
	DWORD dwErrorCode = NO_ERROR;
	HANDLE hFile = NULL;
	...
	try
	{
		...
		{
			LPVOID ptrCrc32Table = (LPVOID)&s_arrdwCrc32Table;
