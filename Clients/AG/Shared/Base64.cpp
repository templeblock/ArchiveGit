...
/////////////////////////////////////////////////////////////////////////////
void CBase64::m_InitializeDecoderTable(void)
{
	...
	//	The table is loaded with table[ASCII_VALUE] = TRANSLATED_VALUE
	 ...
	 // Let's be a	little forgiving about end-of-lines, tabs, spaces,	etc.
...
/////////////////////////////////////////////////////////////////////////////
BOOL CBase64::Decode(const	CByteArray&	source, CByteArray& destination)
{
	...
	//	Since	we're	decoding, we are most likely in a performance-minded part of an application,
	//	let's	go	for a	speedy method for	accessing the source	data.
	...
	while	(index <	number_of_bytes_to_decode)
	{
		...
		if	(character_1 != END_OF_BASE64_ENCODED_DATA)
		{
			...
			{
				//EVAL(TEXT("Character 1	Failed translation at index "), index);
			...
			if	(character_2 != END_OF_BASE64_ENCODED_DATA)
			{
				...
				{
					//EVAL(TEXT("Character 2	Failed translation at index "), index);
					destination.RemoveAll();
					return(FALSE);
				}
				...
				if	(character_3 != END_OF_BASE64_ENCODED_DATA)
				{
					...
					{
						//EVAL(TEXT("Character 3	Failed translation at index "), index);
						destination.RemoveAll();
						return(FALSE);
					}
					...
					if	(character_4 != END_OF_BASE64_ENCODED_DATA)
					{
						...
						{
							//EVAL(TEXT("Character 4	Failed translation at index "), index);
							destination.RemoveAll();
							return(FALSE);
						}
					}
					...
					{ 
						//E(TEXT("Not enough translatable	data"));
						destination.RemoveAll();
						return(FALSE);
					}
				}
...
/////////////////////////////////////////////////////////////////////////////
BOOL CBase64::Decode(const	CString&	source, CByteArray& destination)
{
	if	(m_DecoderTable[0] == 0x00)
	{
		m_InitializeDecoderTable();
...
/////////////////////////////////////////////////////////////////////////////
BOOL CBase64::Encode(const	CByteArray&	source, CByteArray& destination)
{
	//	We	don't	want to make this	static so we can reduce	our footprint in the	library
...
/////////////////////////////////////////////////////////////////////////////
BOOL CBase64::Encode(const	CByteArray&	source, CString& destination_string)
{
	const	char alphabet[] =	"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
