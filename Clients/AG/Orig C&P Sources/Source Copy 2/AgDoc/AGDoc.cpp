...
//--------------------------------------------------------------------------//
//--------------------------------------------------------------------------//
void CAGDoc::GetQFPageRect(int nPage, bool bPortrait, bool bMaxMargin,
							CAGDC *pDC, CAGDCInfo &di, RECT &DestRect,
							bool &bFlip, bool &bRotated)
{
	//----------------------------------------------------------------------//
...
//--------------------------------------------------------------------------//
//--------------------------------------------------------------------------//
void CAGDoc::GetSFPageRect(int nPage, bool bPortrait, bool bMaxMargin,
							CAGDC *pDC, CAGDCInfo &di, RECT &DestRect,
							bool &bFlip, bool &bRotated)
{
	//----------------------------------------------------------------------//
...
//--------------------------------------------------------------------------//
bool CAGDoc::PrintCardQuarter(char *pszDriver, char *pszDevice,
