...
public:
	CAGSpec();
	CAGSpec(const LOGFONT& Font, COLORREF Color, eTSJust HorzJust = eRagRight, int nAboveParaLeading = 0, int nBelowParaLeading = 0, int nLineLeading = 0);
...
public:
	...
	void SetText(const char* pText, int nChars, int nSpecs, const CAGSpec* pAGSpecs, const int* pSpecOffsets);
