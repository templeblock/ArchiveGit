...
public:
	CAGMatrix()
		{ Unity(); }
	CAGMatrix(double m11, double m12, double m21, double m22, double m31 = 0, double m32 = 0)
	...
	void ScaleAndCenter(const RECT& DestRect, const RECT& SrcRect, bool bFlip = false);
	void SetMatrix(double m11, double m12, double m21, double m22, double m31 = 0, double m32 = 0);
