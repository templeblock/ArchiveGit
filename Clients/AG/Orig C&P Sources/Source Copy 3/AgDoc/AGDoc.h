...
public:
	...
	bool PrintCardQuarter(char* pszDriver, char* pszDevice, char* pszOutput, DEVMODE* pDevMode, const char* pszFileName = NULL);
	bool PrintCardSingle(PRINTSIDE PrintSide, char* pszDriver, char* pszDevice, char* pszOutput, DEVMODE* pDevMode, bool& bRotated, const char* pszFileName = NULL);
...
protected:
	void GetQFPageRect(int nPage, bool bPortrait, bool bMaxMargin, CAGDC* pDC, CAGDCInfo& di, RECT& DestRect, bool& bFlip, bool& bRotated);
	void GetSFPageRect(int nPage, bool bPortrait, bool bMaxMargin, CAGDC* pDC, CAGDCInfo& di, RECT& DestRect, bool& bFlip, bool& bRotated);
