@echo off
set PluginFile=..\..\Source\NpPopup\Release\NpPopup.dll
set InstallScript=installPopup.js
set InstallScriptInJar=install.js
set JarFile=NpPopup.jar
...
rem If you want to use a sub-folder, set subfolder=%folder%\PluginDir
if exist %folder%\*.* rmdir/s/q %folder%
md %folder%
rem If you want to use a sub-folder, md %subfolder%
