...
namespace ImageEffects
{
	...
	public: 
		...
		/// <param name="octaves">number of octaves of turbulence</param>
		/// <returns> turbulence value at (x,y)</returns>
	...
	private:
		...
		/// <param name="x">the x value</param>
		/// <returns> noise value at x in the range -1..1</returns>
	public:
		...
		/// <returns> noise value at (x,y)</returns>
		...
		/// <param name="y">the y coordinate</param>
		/// <param name="y">the y coordinate</param>
		/// <returns> noise value at (x,y,z)</returns>
	...
	private:
		...
		/*internal*/ void  normalize3(float* v)
		{
	...
	public:
		...
		/// normalising the function.
		/// 
		float* findRange(Function2D f, float* minmax)
		{
			if (minmax == null)
				minmax = new float[2];
			float min = 0, max = 0;
