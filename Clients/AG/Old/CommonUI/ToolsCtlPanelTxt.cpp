...
//////////////////////////////////////////////////////////////////////
void CToolsCtlPanelText::ActivateNewDoc()
{
	FillFontSizeCombo();
}
...
//////////////////////////////////////////////////////////////////////
void CToolsCtlPanelText::FillFontSizeCombo()
{
...
void CToolsCtlPanelText::InitToolCtrls()
{
	...
	m_ButtonSpellChk.InitDialog(GetDlgItem(IDC_SPELLCHECK), IDR_BOTTOM);
}
...
//////////////////////////////////////////////////////////////////////
LRESULT CToolsCtlPanelText::OnSpellCheck(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled)
{
...
//////////////////////////////////////////////////////////////////////
LRESULT CToolsCtlPanelText::OnMeasureItem(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
...
//////////////////////////////////////////////////////////////////////
LRESULT CToolsCtlPanelText::OnDrawItem(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	UINT idControl = wParam;
