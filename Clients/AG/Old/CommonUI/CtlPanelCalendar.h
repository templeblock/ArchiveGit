// CtlPanelCalendar.h: interface for the CCtlPanelCalendar class.
//
//////////////////////////////////////////////////////////////////////
...
class CCtlPanelCalendar : public CCtlPanel  
{
public:
	CCtlPanelCalendar(CCtp* pMainWnd);
	~CCtlPanelCalendar();
...
public:
	...
	BEGIN_MSG_MAP(CCtlPanelCalendar)
