...
public class ImportKey  {
    ...
    public static void main ( String args[]) {
        ...
        String keypass = "agi_code_rocks";
        
        // change this if you want another alias by default
        String defaultalias = "AGICodeSigning";
...
//                  "keystore.ImportKey"; // especially this ;-)
        ...
        if (args.length < 2 || args.length>4) {
            System.out.println("Usage: java comu.ImportKey keyfile certfile [alias] [keypass]");
            System.exit(0);
        } else {
            keyfile = args[0];
            certfile = args[1];
