...
/* $Id: p_annots.c,v 1.15.2.4 2002/01/21 19:49:46 tm Exp $
 *
    ...
    const char *filename)
{
    ...
    PDF_TRACE(("%s\t(pdf[%p], %f, %f, %f, %f, \"%s\");\n",
    	fn, (void *) p, llx, lly, urx, ury, filename));
    ...
    const char *desttype)
{
    ...
    PDF_TRACE(("%s\t(pdf[%p], %f, %f, %f, %f, %d, \"%s\");\n",
    	fn, (void *) p, llx, lly, urx, ury, page, desttype));
