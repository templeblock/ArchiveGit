...
{
	COLORREF rgbLabelBackground = (m_pCtp->IsHpUI() ? RGB(147,165,182) : RGB(171,170,202));
	...
	m_ButtonNext.InitDialog(GetDlgItem(IDC_DOC_PAGENEXT), IDR_PAGENEXT, BMPBTN_AUTOFIRE);
	m_ButtonPrev.InitDialog(GetDlgItem(IDC_DOC_PAGEPREV), IDR_PAGEPREV, BMPBTN_AUTOFIRE);

	return IDOK;
}

//////////////////////////////////////////////////////////////////////
void CPagePanel::AddToolTip(UINT idControl)
{
	TOOLINFO ti;
