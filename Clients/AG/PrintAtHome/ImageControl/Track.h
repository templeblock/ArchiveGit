...
public:
	void Init(CAGDC* pDC, int iWhatCanDo, DRAWPROC lpDrawProc, void* pData, CRect& SymbolRect, CRect& BoundRect, CRect& PageRect, CAGMatrix& ViewToDeviceMatrix, CAGMatrix& SymbolMatrix, CGrid& Grid);
