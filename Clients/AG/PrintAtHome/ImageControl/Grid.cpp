...
/////////////////////////////////////////////////////////////////////////////
void CGrid::Draw(HDC hDC, const CAGMatrix& Matrix, const CSize& PageSize)
{
	if (!m_bOn)
		return;
...
/////////////////////////////////////////////////////////////////////////////
void CGrid::SnapSize(CRect& rect)
{
	if (!m_bOn)
		return;
...
/////////////////////////////////////////////////////////////////////////////
void CGrid::SetSize(const CSize& size)
{
	m_Size = size;
