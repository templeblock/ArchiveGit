...
#define VER_COPYRIGHT			"Copyright © 2000-2006 AG.com, Inc.\0"
...
#define VER_PRODUCT_VERSION 	 1,0,6023,0
#define VER_PRODUCT_VERSION_STR "1.0 (build 6023)"
#define VER_FILE_VERSION		VER_PRODUCT_VERSION
#define VER_FILE_VERSION_STR	VER_PRODUCT_VERSION_STR

#define VER_INTERNAL_NAME		"ImageControl\0"
#define VER_FILE_NAME			"ImageControl.dll\0"
#define VER_MIMETYPE
