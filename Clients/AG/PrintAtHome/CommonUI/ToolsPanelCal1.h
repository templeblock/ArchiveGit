...
class CToolsPanelCal1 : public CToolsCtlPanelCommon
{
public:
	CToolsPanelCal1(CCtp* pMainWnd);
	virtual ~CToolsPanelCal1();

	enum { IDD = IDD_TOPTOOLSPANEL_CALENDAR };
