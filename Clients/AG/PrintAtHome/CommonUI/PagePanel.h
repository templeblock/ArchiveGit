...
public:
	...
	LRESULT OnSwitchToCard(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnSwitchToEnvelope(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
...
public:
	BEGIN_MSG_MAP(CPagePanel)
		...
		COMMAND_ID_HANDLER(IDC_BTN_CARD, OnSwitchToCard)
		COMMAND_ID_HANDLER(IDC_BTN_ENVELOPE, OnSwitchToEnvelope)
...
protected:
	...
	CBmpButton m_ButtonCard;
	CBmpButton m_ButtonEnvelope;
