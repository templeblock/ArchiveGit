...
LRESULT CEnvelopeWizard::OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	GetDlgItem(IDC_STEP1_STATIC).SetFont(m_hHdrFont2);
	GetDlgItem(IDC_STEP2A_STATIC).SetFont(m_hHdrFont2);
	GetDlgItem(IDC_STEP3_STATIC).SetFont(m_hHdrFont2);
	GetDlgItem(IDC_STEP4_STATIC).SetFont(m_hHdrFont2);
...
//////////////////////////////////////////////////////////////////////
void CEnvelopeWizard::SetAddressText(CAGSymText* pText, CString& strText, bool bClearText)
{
	if (!pText)
		return;
