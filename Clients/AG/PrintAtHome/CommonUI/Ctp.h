...
#include "..\AxCtp3\AxCtp3.h"
#include "..\AxCtp3\CtpEvents.h"
...
class ATL_NO_VTABLE CCtp : 
	...
	public IDispatchImpl<ICtp, &IID_ICtp, &LIBID_AXCTP3Lib>,
	...
	public IProvideClassInfo2Impl<&CLSID_Ctp, &DIID__ICtpEvents, &LIBID_AXCTP3Lib>, //j
...
//j	HRESULT OnDraw(ATL_DRAWINFO& di);
	...
	STDMETHOD(LoadSrc)(VARIANT varSrc);
