...
public:
	...
	bool m_bPrintRibbonHoles;
	bool m_bRibbonHolesVertical;
	
	double m_fRibbonHoleEdgeDistance;
	double m_fRibbonHoleSpacing;
...
/////////////////////////////////////////////////////////////////////////////
// CNewDocWizIntro
class CNewDocWizIntro : public CPropertyPageImpl<CNewDocWizIntro>
{
public:
...
public:
	BEGIN_MSG_MAP(CNewDocWizIntro)
		...
		CHAIN_MSG_MAP(CPropertyPageImpl<CNewDocWizIntro>)
	END_MSG_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CNewDocWizStep1
class CNewDocWizStep1 : public CPropertyPageImpl<CNewDocWizStep1>
{
public:
...
public:
	BEGIN_MSG_MAP(CNewDocWizStep1)
		...
		CHAIN_MSG_MAP(CPropertyPageImpl<CNewDocWizStep1>)
	END_MSG_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CNewDocWizStep2
class CNewDocWizStep2 : public CPropertyPageImpl<CNewDocWizStep2>
{
public:
...
public:
	BEGIN_MSG_MAP(CNewDocWizStep2)
		...
		CHAIN_MSG_MAP(CPropertyPageImpl<CNewDocWizStep2>)
	END_MSG_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CNewDocWizEnd
class CNewDocWizEnd : public CPropertyPageImpl<CNewDocWizEnd>
{
public:
...
public:
	BEGIN_MSG_MAP(CNewDocWizEnd)
		CHAIN_MSG_MAP(CPropertyPageImpl<CNewDocWizEnd>)
	END_MSG_MAP()
...
/////////////////////////////////////////////////////////////////////////////
// CDocWizRibbonHolesPage
class CDocWizRibbonHolesPage : public CPropertyPageImpl<CDocWizRibbonHolesPage>
{
public:
	enum { IDD = IDD_DOCWIZRIBBONHOLES };
	...
	LRESULT OnPrintRibbonHoles(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnHoleShape(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnEdgeDistance(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnHoleSpacing(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnHolesVertical(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
	LRESULT OnHolesHorizontal(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);

public:
	BEGIN_MSG_MAP(CDocWizRibbonHolesPage)
		COMMAND_HANDLER(IDC_CHECK_RH_PRINT, BN_CLICKED, OnPrintRibbonHoles)
		COMMAND_HANDLER(IDC_COMBO_RH_SHAPES, CBN_SELCHANGE, OnHoleShape)
		COMMAND_HANDLER(IDC_EDIT_RH_EDGEDISTANCE, EN_CHANGE, OnEdgeDistance)
		COMMAND_HANDLER(IDC_EDIT_RH_HOLESPACING, EN_CHANGE, OnHoleSpacing)
		COMMAND_HANDLER(IDC_RADIO_RH_VERT, BN_CLICKED, OnHolesVertical)
		COMMAND_HANDLER(IDC_RADIO_RH_HORZ, BN_CLICKED, OnHolesHorizontal)
		CHAIN_MSG_MAP(CPropertyPageImpl<CDocWizRibbonHolesPage>)
	END_MSG_MAP()
