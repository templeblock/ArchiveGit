================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PAHStudio Project Overview
===============================================================================

The application wizard has created this PAHStudio application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PAHStudio application.
...
PAHStudio.h
    ...
    CPAHStudioApp application class.
...
res\PAHStudio.ico
    ...
    icon is included by the main resource file PAHStudio.rc.
...
PAHStudioDlg.h, PAHStudioDlg.cpp - the dialog
    These files contain your CPAHStudioDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in PAHStudio.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CPAHStudioDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named PAHStudio.pch and a precompiled types file named StdAfx.obj.
