...
#pragma comment(lib, "version.lib") // for VerQueryValue, GetFileVersionInfoSize, and GetFileVersionInfo
...
/////////////////////////////////////////////////////////////////////////////
bool CModuleVersion::GetProductVersion(LPTSTR szProductversion, int iMaxLength)
{
	CString strProductVersion = GetValue("ProductVersion");
	::ZeroMemory(szProductversion, iMaxLength);
	::CopyMemory(szProductversion, strProductVersion, min(strProductVersion.GetLength(), iMaxLength-1));
	return true;
}

/////////////////////////////////////////////////////////////////////////////
// Key name is something like "ProductVersion", "CompanyName", "FileDescription", etc
