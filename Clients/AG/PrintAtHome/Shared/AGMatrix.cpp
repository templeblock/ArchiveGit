...
void CAGMatrix::Center(const CRect& DestRect, const CRect& SrcRect)
{
...
void CAGMatrix::ScaleToFit(const CRect& DestRect, const CRect& SrcRect, bool bUseSmallerFactor)
{
	double scx = (double)(SrcRect.left + SrcRect.right) / 2;
	double scy = (double)(SrcRect.top + SrcRect.bottom) / 2;
...
//////////////////////////////////////////////////////////////////////
// Adjust the matrix to stretch the source within the destination rectangle
void CAGMatrix::StretchToFit(const CRect& DestRect, const CRect& SrcRect)
{
	double scx = (double)(SrcRect.left + SrcRect.right) / 2;
	double scy = (double)(SrcRect.top + SrcRect.bottom) / 2;
...
void CAGMatrix::Transform(CRect& Rect) const
{
	if (IsSimple())
	{
...
//////////////////////////////////////////////////////////////////////
void CAGMatrix::TransformRectToPolygon(const CRect& Rect, POINT pt[4]) const
{
...
void CAGMatrix::TransformBounds(CRect& Rect) const
{
	if (IsUnity())
		return;
