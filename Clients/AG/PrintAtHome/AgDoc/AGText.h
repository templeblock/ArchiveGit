...
public:
	...
	void DrawTextAligned(CAGDC* pDC, LPCSTR pString, int* pWidths, RECT& RectAlign, eVertJust VertJust) const;
	void DrawText(CAGDC* pDC, LPCSTR pString, int* pWidths, int x, int y, RECT* pRectAlign = NULL) const;
...
protected:
	void DrawCaret(HDC hDC, const CAGMatrix& Matrix, const RECT& rect);
	void DrawSelection(HDC hDC, const CAGMatrix& Matrix, const RECT& rect);
