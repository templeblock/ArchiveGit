...
{
	return 'images/help/' + imgfile;
}

function WriteTopic(topic, strBackTopic)
{
	SetTopic(topic, strBackTopic);
	...
	else if (topic == '8')
	{
		...
		<a target="email" href="' + g_ahost + '/customer/emailus_plugin.pd?source=app">Email us, write to us, or contact our parent company</a> \
		</p> \
		';
	}
	else if (topic == '40')
