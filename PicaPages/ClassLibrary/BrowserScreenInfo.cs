...
namespace ClassLibrary
{
	...
	public static class BrowserScreenInformation
	{
		...
		public static double ClientWidth
		{
			get
			{
				return IsNavigator ? (double)HtmlPage.Window.GetProperty("innerWidth")
		...
		public static double ClientHeight
		{
			get
			{
				return IsNavigator ? (double)HtmlPage.Window.GetProperty("innerHeight")
		...
		public static double ScrollLeft
		{
			get
			{
				return IsNavigator ? (double)HtmlPage.Window.GetProperty("pageXOffset")
		...
		public static double ScrollTop
		{
			get
			{
				return IsNavigator ? (double)HtmlPage.Window.GetProperty("pageYOffset")
		...
		public static double ScreenPositionLeft
		{
			get
			{
				return IsNavigator ? (double)HtmlPage.Window.GetProperty("screenX")
		...
		public static double ScreenPositionTop
		{
			get
			{
				return IsNavigator ? (double)HtmlPage.Window.GetProperty("screenY")
		...
		/// </summary> 
		public static bool IsNavigator
		{
			get
			{
				return HtmlPage.BrowserInformation.Name.Contains("Netscape");
			}
		}
	}
}
