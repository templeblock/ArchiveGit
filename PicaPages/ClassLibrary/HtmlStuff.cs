...
namespace ClassLibrary
{
	...
	public class HtmlStuff
	{
		...
		/// </summary>
		private string[] Colors = { "red", "blue", "gray" };
		...
		public void ImportClick()
		{
			...
			{
				// update
				string newValue = (string)txt.GetProperty("value");
		...
		public void CreateHtmlForm()
		{
			...
			_btnAdd.AttachEvent("onclick", delegate(object sender, HtmlEventArgs e)
			{
				...
				string title = (string)_txtTitle.GetProperty("value");
				string url = (string)_txtUrl.GetProperty("value");
