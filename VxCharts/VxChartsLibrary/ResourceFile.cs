...
namespace ClassLibrary
{
	...
	public static class ResourceFile
	{
		...
		public static BitmapImage GetBitmap(string relativeUri, From assembly)
		{
		...
		public static BitmapImage GetBitmapFromZip(string relativeZipUri, string relativeUri, From assembly)
		{
		...
		public static string GetFileText(string relativeUri, From assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		public static string GetFileTextFromZip(string relativeZipUri, string relativeUri, From assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetFileTextFromStream(stream);
		}
		...
		public static string GetFileTextFromStream(Stream stream)
		{
			if (stream == null)
				return null;
		...
		public static FontSource GetFont(string relativeUri, From assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		public static FontSource GetFontFromZip(string relativeZipUri, string relativeUri, From assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetFontFromStream(stream);
		}
		...
		public static UIElement GetXaml(string relativeUri, From assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		public static UIElement GetXamlFromZip(string relativeZipUri, string relativeUri, From assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetXamlFromStream(stream);
		}
		...
		public static UIElement GetXamlFromStream(Stream stream)
		{
			if (stream == null)
				return null;
		...
		public static XmlReader GetXmlReader(string relativeUri, From assembly)
		{
			Stream stream = GetStream(relativeUri, assembly);
		...
		public static XmlReader GetXmlReaderFromZip(string relativeZipUri, string relativeUri, From assembly)
		{
			Stream stream = GetStreamFromZip(relativeZipUri, relativeUri, assembly);
			return GetXmlReaderFromStream(stream);
		}
...
//j				MessageBox.Show(ex.Message, "Alert", MessageBoxButton.OK);
		...
		public static string GetXmlFromXmlReader(XmlReader xmlReader)
		{
			return (xmlReader != null ? xmlReader.ReadOuterXml() : null);
		}

		// Get a resource file stream info from an assembly or the XAP
		public static StreamResourceInfo GetStreamInfo(string relativeUri, From assembly)
		{
		...
		public static Stream GetStream(string relativeUri, From assembly)
		{
		...
		public static Stream GetStreamFromZip(string relativeZipUri, string relativeUri, From assembly)
		{
		...
		// Get a resource file stream from inside a ZIP stream
		public static Stream GetStreamFromZipStream(Stream zipStream, string relativeUri)
		{
			if (zipStream == null)
				return null;
...
//j		public string Name { get { return (Assembly != null ? Assembly.FullName.Substring(0, Assembly.FullName.IndexOf(',')) : null); } }
		public string Name { get { return (Assembly != null ? Assembly.Name() : null); } }

		// From current application assembly
		public static From App { get { return new From() { Assembly = Application.Current.GetType().Assembly }; } }

		// From the caller's assembly
		public static From This { get { return new From() { Assembly = Assembly.GetCallingAssembly() }; } }

		// From a library assembly
		public static From Library { get { return new From() { Assembly = Assembly.GetExecutingAssembly() }; } }

		// From an assembly containing a known type
		public static From Type<TT>() { return new From() { Assembly = typeof(TT).Assembly }; }
	}
}
