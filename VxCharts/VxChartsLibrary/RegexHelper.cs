...
namespace ClassLibrary
{
	...
	public class RegexHelper
	{
		...
		public static string ReplacePattern(string input, string pattern, int matchGroup, Dictionary<string, string> replacementDictionary, out int count)
		{
			int ncount = 0;
		...
		// Extension for string
		public static string ReplacePattern(string input, string pattern, string replace)
		{
			Regex regex = new Regex(pattern, RegexOptions.None/*Compiled*/);
		...
		// Extension for string
		public static string ReplaceCStyleComments(string input)
		{
			return ReplacePattern(input, @"/\*(?:.|[\n\r])*?\*/", "");
		}

		// Extension for string
		public static string WildcardToPattern(string pattern, WildcardSearch matchType)
		{
