...
namespace Pivot.Web
{
	// Class name becomes "MembershipContext" on the client side if named "MembershipService" here
	[EnableClientAccess]
...
//j			User oldUser = authentication.Logout();
		...
		//private static string ActionAbsolute(this UrlHelper url, string actionName, string controllerName)
		//{
	...
	public class MembershipServiceHostFactory : DomainServiceHostFactory
	{
		protected override ServiceHost CreateServiceHost(Type serviceType, Uri[] baseAddresses)
		{
			...
			if (!bLocalHost) // Specify the exact URL of the web service
				...
				{
//j					new Uri("http://dreamnit.com/Pivot.Web/Services/Pivot-Web-MembershipService.svc"),
					new Uri("http://dreamnit.com/Pivot.Web/Services/Pivot-Web-MembershipService.svc"),
				};
