...
<%@ Page Language="C#" CodeBehind="Default.aspx.cs" Inherits="Pivot.Web.DefaultPage" AutoEventWireup="True" EnableViewState="false" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
	<title>McPivot</title>
	<meta http-equiv="X-UA-Compatible" content="IE=8"></meta>
	<meta name="description" content="The easiest way to find baseball data online."></meta>
	<meta name="keywords" content="baseball,pivot,pivotviewer,lahman,database,reference"></meta>
	<style type="text/css">
		html
		{
			height: 100%;
	...
	<script type="text/javascript">
		...
		{
			<%	// Name, Summary, and SampleQueries
				string output = null;
				foreach (string item in PivotServerTools.PivotHttpHandlers.GetCollectionUrls())
				{
					output += (output == null ? "return [ " : ", ");
					output += "\"" + /*HttpUtility.HtmlEncode*/(item) + "\"";
				}
				output += " ];";
		...
		function CollectionInfoHtml()
		{
			<%	// From the discovered factories
				Response.Write("return \"" + PivotServerTools.PivotHttpHandlers.CollectionInfoHtml() + "\";");
			%>
		}
	</script>
</head>
<body>
	<form id="form1" runat="server" style="height:100%;">
		...
		<div id="silverlightControlHost">
			...
			<param name="source" value="ClientBin/Pivot.xap"/>
				<param name="initParams" value="cxml=0" /><%--Comma separated name=value pairs--%>
				...
				<div id="silverlightNotInstalled">
					<h3>McPivot. &nbsp; The easiest way to find baseball data online.</h3>
